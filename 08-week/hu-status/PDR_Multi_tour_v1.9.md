...
Una vez cerrado conforme a la sección 24, este PDR debe tratarse como línea base funcional final de Fase 1 para la entrega académica y como referencia base para alinear la documentación del proyecto en su repositorio autoritativo, sin que dicha alineación se considere realizada por el solo hecho de existir este documento.
...
- Decisiones del equipo Q1 a Q6 en la versión 1.9 - 2026-09-23: retención de datos cuando una salida lleva más de 7 días sin regularizar (Q1); definición de días hábiles y país del tenant (Q2); congelación de plazos económicos desde la cancelación o interrupción de la salida (Q3); penalidad y monto reembolsable en la cancelación solicitada por el cliente (Q4); detección de coincidencias de correo sin fusión automática (Q5); creación automática de caja para cualquier movimiento no efectivo (Q6).
- Decisiones del equipo R1 y R2 y correcciones editoriales en la versión 1.9 - 2026-09-23: el Administrador del tenant resuelve las coincidencias de correo no verificado sin fusión automática (R1); el país del tenant puede modificarlo el Administrador del tenant con auditoría y efecto solo prospectivo (R2). Correcciones: se precisa que las alertas se muestran en el panel y que el cierre definitivo de una reserva cancelada sin valores por tratar ocurre en la cancelación.
- Cierre documental definitivo de la versión 1.9 - 2026-09-23: con las decisiones R1 y R2 y las correcciones de canal de alertas y de cierre definitivo sin valores por tratar, la auditoría final no identifica decisiones humanas pendientes ni contradicciones; la sección 24 pasa a declaración de cierre y la versión 1.9 se declara línea base funcional final de Fase 1. [Reemplazada: auditorías posteriores identificaron nuevas brechas; el cierre queda sujeto a una nueva auditoría final.]
- Cierre de la auditoría final de la versión 1.9 - 2026-09-23: se aplican las correcciones documentales finales D-01 a D-05, sin cambios funcionales: permisos del Colaborador operativo para la ejecución de salidas y la caja (D-01), autorización de las devoluciones determinadas automáticamente (D-02), excepción de la cancelación solicitada por el cliente durante una reprogramación (D-03), actor responsable de la ejecución de salidas (D-04) y auditoría de la asignación y el retiro de permisos especiales (D-05). Después de estas correcciones no quedan decisiones humanas pendientes ni contradicciones funcionales abiertas, la trazabilidad fue validada y el PDR v1.9 queda listo para cierre. [Reemplazada: la auditoría adversarial posterior identificó AB-01 y AB-02, resueltas en la entrada siguiente.]
- Decisiones del equipo AB-01 y AB-02 y correcciones AC-01 y AC-02 de la auditoría adversarial de la versión 1.9 - 2026-09-23: en una emergencia personal durante la ejecución, Multitour calcula de inmediato el monto reembolsable según la política vigente y, si es mayor que $0, la devolución queda determinada y autorizada automáticamente (AB-01); la caja creada automáticamente nace Abierta con origen automático y se cierra automáticamente al final del día si no tuvo apertura operativa ni efectivo (AB-02); se explicita la congelación de las tres decisiones financieras de 24 horas con el tenant inactivo (AC-01) y se unifica la notificación de las devoluciones determinadas automáticamente (AC-02). Con estas decisiones no quedan decisiones humanas pendientes. [Reemplazada: la auditoría exhaustiva posterior identificó GAP-001 a GAP-032, resueltos en la entrada siguiente.]
- Decisiones del equipo GAP-001 a GAP-021 y correcciones GAP-022 a GAP-032 de la auditoría exhaustiva de la versión 1.9 - 2026-09-23 (identificadores propios de esa auditoría, distintos de GAP-01 a GAP-11 de la sección 24.2): se resuelven 19 decisiones pendientes y 2 contradicciones sobre plazos de contingencia y retención con el tenant inactivo, comprobantes aprobados tarde, validación y ejecución durante la inactivación, respuesta a la reprogramación, cupos al reducir viajeros, inicio y cambio de horario de salidas, caja no cerrada y devoluciones por transferencia posteriores al cierre, saldo a favor, recuperación del administrador, zona horaria, fijación de precios, acceso de emergencia a datos sensibles y regularización de salidas; se alinean textos (GAP-022 a GAP-027) y la trazabilidad y el historial (GAP-028 a GAP-032). Se retira la declaración de cierre de la sección 24 hasta una nueva auditoría final.
- Decisiones del equipo FINAL-001 a FINAL-009 de la auditoría final de regresión de la versión 1.9 - 2026-09-23: consecuencias de plazos ya vencidos al resolver comprobantes durante la inactivación (FINAL-001); congelación incondicional de la respuesta a la reprogramación con registro de respuestas externas (FINAL-002); cambio de fecha u hora de salidas con reservas mediante cancelación y nueva salida (FINAL-003); alcance del contexto comercial fijado (FINAL-004); penalidad calculada una sola vez con comprobantes aprobados tarde (FINAL-005); hora real anterior en la regularización (FINAL-006); cambio de zona horaria y caja (FINAL-007); alcance del permiso Gestionar ejecución de salidas (FINAL-008); nuevos criterios CA-032 a CA-034 y trazabilidad (FINAL-009). El cierre sigue sujeto a una nueva auditoría final.
- Decisión del equipo FINAL-010 de la versión 1.9 - 2026-09-23: toda propuesta de reprogramación cuya salida propuesta se cancela queda sin efecto y libera sus cupos; con el tenant activo se abre un nuevo plazo L1 de 24 horas y una nueva propuesta tiene 72 horas propias; con el tenant inactivo y cancelación por I1, la reserva se cancela con devolución del 100 %, sin encadenar propuestas durante esa inactivación. El cierre sigue sujeto a una nueva auditoría final. [Ajustada posteriormente por FINAL-011.]
- Decisión del equipo FINAL-011 de la versión 1.9 - 2026-09-23: cada cancelación o interrupción de la salida original inicia un único episodio de reprogramación con un límite absoluto de 96 horas corridas que las propuestas sustitutas no reinician; el plazo de respuesta es el menor entre 72 horas, el tiempo restante del episodio y la hora de la salida propuesta; la aceptación efectiva cierra el episodio. El cierre sigue sujeto a una nueva auditoría final. [Ajustada por la entrada siguiente: el límite de 96 horas es computable y su cómputo solo se pausa durante una respuesta congelada por inactividad.]
- Ajuste de FINAL-011 en la versión 1.9 - 2026-09-23: el límite máximo computable del episodio de reprogramación es de 96 horas y su cómputo solo se pausa mientras una propuesta pendiente tenga su plazo de respuesta congelado por la inactividad del tenant; sin propuesta pendiente, L1 y el episodio siguen corriendo; el nuevo L1 tras una propuesta sin efecto dura el menor entre 24 horas y el tiempo restante del episodio; la interrupción de la salida inicia un episodio igual que la cancelación; con la salida propuesta cancelada por I1 prevalece FINAL-010. El cierre sigue sujeto a una nueva auditoría final.
...
- Colaborador operativo: puede registrar reservas, consultar reservas del día y próximas, registrar seguimiento de reservas pendientes de pago, registrar el inicio, la finalización, las interrupciones y las novedades de las salidas y regularizarlas con el permiso Gestionar ejecución de salidas, sin cancelar salidas futuras Programadas, registrar la ejecución, registrar gastos operacionales reales y abrir, cerrar y reabrir caja con el permiso Gestionar caja dentro de los límites definidos por el negocio.
...
- Únicamente cuando no sea posible obtener dicha autorización y exista una incidencia crítica puede utilizarse un mecanismo excepcional de acceso de emergencia, con justificación obligatoria, mínimo privilegio, duración máxima de 24 horas y auditoría completa. El acceso de emergencia solo alcanza datos sensibles cuando el incidente lo requiere explícitamente y su alcance registrado los incluye de forma expresa, con justificación específica; sin esa habilitación explícita, los datos sensibles quedan excluidos (GAP-020). Multitour debe enviar un correo electrónico a todos los Administradores del tenant activos al iniciarse el acceso y otro al finalizar. Los correos deben indicar como mínimo el tenant afectado, el Administrador de plataforma que realizó el acceso, el motivo o justificación, la fecha y hora de inicio y el alcance del acceso; el correo de finalización debe indicar además la fecha y hora de finalización. Ninguno debe incluir información médica ni datos sensibles consultados (J4). Si el correo falla, el acceso no se invalida, pero el fallo de notificación debe quedar registrado (decisión del equipo H17 — 2026-09-23).
...
- Esta gestión no habilita administración avanzada de roles ni permisos personalizados, que permanecen fuera del alcance de Fase 1. Los únicos permisos especiales asignables en Fase 1 son cuatro: Validar comprobantes, Consultar datos sensibles, Gestionar caja y Gestionar ejecución de salidas. El permiso Gestionar ejecución de salidas habilita a un Colaborador operativo para registrar el inicio y la finalización reales de una salida, registrar sus interrupciones y novedades operativas —incluida, cuando corresponda, la emergencia personal de un cliente durante la ejecución—, regularizar una salida pasada, incluido registrar que no se realizó y quedó Cancelada, y ejecutar las actuaciones extraordinarias de ejecución autorizadas por RN-EJE-002. Este permiso no habilita a cancelar libremente una salida futura Programada, que sigue siendo responsabilidad del Administrador del tenant (decisiones del equipo G5 y FINAL-008 — 2026-09-23). El Administrador del tenant tiene por su perfil los permisos Validar comprobantes, Gestionar caja y Gestionar ejecución de salidas. El permiso Consultar datos sensibles no se otorga por perfil: debe asignarse de forma explícita a cada usuario que lo requiera, incluidos los Administradores del tenant; un Administrador del tenant puede asignárselo a sí mismo. Los permisos especiales los asignan y retiran los Administradores del tenant; toda asignación o retiro de un permiso especial queda auditado, al igual que cada consulta de datos sensibles (H9, J5, K4).
...
- Cada tenant tiene configurada una zona horaria oficial, definida al crear el tenant y modificable por el Administrador del tenant con efecto prospectivo, sin reinterpretar operaciones históricas: las salidas y los registros ya creados conservan la zona horaria y el instante con que fueron creados, los plazos ya iniciados no se reinterpretan, las cajas existentes conservan la zona horaria con la que fueron creadas y las nuevas operaciones usan la nueva zona horaria (GAP-017). Un cambio de zona horaria no puede activarse mientras exista una caja Abierta o con la marca Pendiente de cierre; primero debe quedar cerrada. Tras activarse, las operaciones nuevas usan de inmediato la nueva zona horaria, las cajas históricas no reinterpretan sus fechas ni recalculan sus movimientos, y cada movimiento posterior se asigna a la caja de su fecha local según la nueva zona: si ya existe una caja para esa fecha, se usa esa misma caja —si está cerrada, un movimiento no efectivo se registra como posterior al cierre y uno en efectivo usa la reapertura autorizada—, y si no existe, se crea o abre según las reglas normales, de modo que nunca hay más de una caja por tenant y fecha. La activación del cambio queda auditada con la zona anterior, la zona nueva, la fecha y hora efectiva y el usuario que lo realizó (FINAL-007). Todas las fechas y horas de la operación del negocio (salidas, cajas, validaciones, vencimientos, reportes e históricos) se interpretan en esa zona horaria y no en la del servidor, el navegador o el dispositivo del usuario. Los plazos expresados en horas corridas representan duraciones reales desde el evento que los inicia; los conceptos basados en día calendario, como la caja diaria y la fecha de los reportes, usan el calendario local del tenant. Para Travesía Natural, la zona horaria es America/Bogota (decisión del equipo G14 — 2026-09-23). Cada tenant tiene además configurado su país, que determina los festivos nacionales para los plazos en días hábiles; para Travesía Natural, el país es Colombia (Q2). El país lo define inicialmente el Administrador de plataforma al crear el tenant y después puede modificarlo el Administrador del tenant; el cambio queda auditado y tiene efecto solo prospectivo: no modifica históricos ni recalcula plazos ya iniciados, y los plazos nuevos usan el país vigente al momento de su creación (R2).
...
- Durante la inactivación, el Administrador del tenant conserva únicamente un acceso restringido destinado a gestionar las obligaciones pendientes derivadas de la inactivación: reservas afectadas, reprogramaciones, devoluciones y autorizaciones excepcionales de soporte. Con ese acceso puede registrar, exclusivamente para regularizar las salidas que ya estaban En ejecución al momento de la inactivación, sus novedades de ejecución, los servicios prestados y no prestados, su interrupción y su cierre, sin iniciar nuevas salidas, reservas ni ventas (L5, GAP-007); puede validar o rechazar únicamente los comprobantes presentados antes de la inactivación, sin aceptar comprobantes ni pagos nuevos (GAP-005); y registrar las devoluciones y los movimientos financieros estrictamente necesarios derivados de dichas obligaciones, y estas acciones quedan auditadas. Este acceso no habilita la operación comercial normal del tenant (E6, E26, G4).
- Durante la inactivación de un tenant se suspenden todos los plazos operativos cuya ejecución depende de acciones del cliente o de usuarios del tenant: plazo de pago inicial, ampliaciones vigentes, plazo del saldo o de una diferencia pendiente, revisión de comprobantes, decisiones financieras de 24 horas corridas —tratamiento de valores abonados después de una cancelación (RN-RES-006C), excedente por una disminución del valor de la reserva (RN-RES-004), monto reembolsable de una cancelación solicitada por el cliente (RF-021) y resolución de una solicitud de devolución de saldo a favor (RN-RES-009)— y plazo de respuesta del cliente a una propuesta de reprogramación, que se congela siempre junto con el tiempo restante del episodio de reprogramación (I2, FINAL-002, FINAL-011); si la salida propuesta se cancela conforme a I1 durante la inactivación, la propuesta queda sin efecto, se liberan sus cupos y la reserva se cancela por causa no atribuible al cliente con devolución del 100 %, sin nuevo plazo L1 ni nuevas propuestas durante esa inactivación (FINAL-010). No se congelan, en cambio, los plazos de contingencia que el Administrador del tenant puede atender con su acceso restringido: las 24 horas corridas para proponer una reprogramación (RN-EJE-002), junto con el cómputo del episodio de reprogramación mientras no exista una propuesta pendiente (FINAL-011), y los 5 días hábiles para ejecutar una devolución determinada (RN-RES-008) (GAP-001). Las cancelaciones automáticas de reservas asociadas a los plazos congelados también quedan suspendidas y no se reciben pagos. Las consecuencias de plazos que ya habían vencido antes de la inactivación sí se aplican cuando un comprobante se resuelve durante ella, conforme a RN-RES-006C (FINAL-001). Al reactivarse el tenant, cada plazo continúa con el tiempo restante que tenía al momento de la inactivación (AC-01). La suspensión no aplica a los temporizadores de seguridad, como credenciales temporales, recuperación de contraseña o accesos excepcionales (A6, G4).
- Cuando la inactivación afecte reservas confirmadas o con pagos recibidos, el Administrador del tenant es responsable de contactar a los clientes afectados para gestionar la continuidad de la obligación adquirida. El cliente puede aceptar la reprogramación del servicio o solicitar la devolución correspondiente (E6). Mientras la salida de la reserva no se haya cancelado ni haya llegado su hora programada, una solicitud voluntaria de cancelación del cliente sigue la política normal de cancelación del cliente (RF-021) y la registra el Administrador del tenant con su acceso restringido; si la salida se cancela o llega su hora mientras el tenant sigue inactivo, la causa pasa a ser no atribuible al cliente y corresponde reprogramación o devolución del 100 % conforme a RN-EJE-002 (GAP-006).
- Si la fecha y hora programadas de una salida se alcanzan mientras el tenant está inactivo, Multitour cancela automáticamente la salida por una causa no atribuible al cliente y sus reservas se gestionan conforme a RN-EJE-002. La reactivación del tenant no reactiva una salida cuya hora programada ya haya transcurrido (I1). Si esa salida era la propuesta de una reprogramación pendiente, la propuesta queda sin efecto y la reserva afectada se cancela con devolución del 100 % conforme a FINAL-010.
...
- Cuando un Colaborador operativo o el Administrador del tenant registren manualmente un cliente, Multitour debe normalizar el correo ingresado y buscar coincidencias dentro del mismo tenant antes de crear un registro nuevo, incluyendo cuentas de cliente con correo verificado, cuentas todavía no verificadas y clientes registrados manualmente. Si existe una cuenta con correo verificado y se cumplen las condiciones de vinculación, debe reutilizarse o vincularse con esa identidad en lugar de crear un duplicado. Si solo existe otro registro con el mismo correo normalizado pero no verificado, Multitour no crea el duplicado ni fusiona automáticamente los registros, y la coincidencia la resuelve el Administrador del tenant: si corresponde a la misma persona, primero se verifica la propiedad del correo y después se realiza la vinculación; si son personas distintas o el correo es incorrecto, debe corregirse la información antes de continuar (R1). No se fusionan automáticamente dos identidades solo porque compartan un correo no verificado: el correo normalizado sirve para detectar posibles duplicados y la verificación del correo permite una vinculación segura (L9, Q5).
...
- Aplicación automática de los descuentos generales fijados al crear la reserva y de los descuentos adicionales autorizados al momento de cobrar o pagar.
...
- Alcance funcional cerrado de autogestión en Fase 1: crear cuenta, iniciar sesión, recuperar contraseña, consultar oferta, crear reserva, consultar estado de la reserva, continuar el proceso de pago según los tipos y medios de pago habilitados, aplicando cuando corresponda su saldo a favor (GAP-015), aceptar o rechazar una propuesta de reprogramación (GAP-008), solicitar la devolución de su saldo a favor (GAP-014) y consultar o descargar los comprobantes asociados a su propia reserva dentro del tenant activo.
- Restricción explícita de Fase 1: modificar, cancelar o reagendar reservas desde autogestión del cliente final queda fuera del alcance actual, salvo actualización formal posterior de este PDR. Responder a una propuesta de reprogramación no equivale a reagendar libremente (GAP-008).
...
- Reglas relacionadas: RN-CLI-001, RN-CLI-003
...
- Reglas relacionadas: RN-CLI-002, RN-CLI-003, RN-RES-005
...
- Comportamiento esperado: Debe permitir cambiar servicios, cantidades, acompañantes, transporte u otros elementos autorizados por el negocio. Toda modificación debe recalcular valores, revalidar capacidad, recalcular los descuentos utilizando los descuentos y reglas comerciales fijados para la reserva al crearla, sin consultar nuevamente los descuentos generales vigentes en ese momento (RN-RES-003, GAP-018); un componente agregado fija su tarifa base vigente al agregarlo y usa los descuentos del contexto original que le sean aplicables (FINAL-004), y determinar si existe saldo adicional por cobrar, saldo a favor o devolución. Los pagos ya registrados no se pierden y deben seguir formando parte del saldo resultante. Si el recálculo produce una devolución potencial, el sistema debe distinguir entre el cálculo del saldo a devolver y la autorización o ejecución efectiva de la devolución monetaria. Si una modificación válida incrementa el valor de una reserva confirmada, esta conserva su estado y se recalcula el saldo pendiente; si lo reduce y genera excedente sobre los pagos validados, el excedente se trata conforme a RN-RES-004 (E18, L7). Si la modificación agrega viajeros a una reserva que ya tiene cupo apartado o asignado, el sistema debe validar la disponibilidad y asignar en ese momento los cupos adicionales; si no hay capacidad suficiente, la modificación no se realiza. Si la modificación reduce los viajeros, los cupos correspondientes se liberan inmediatamente en la misma operación (GAP-009). Un cambio de fecha se rige por RN-EJE-006 (E25).
...
- Comportamiento esperado: Debe aplicar los descuentos generales fijados en el contexto comercial de la reserva al crearla, aunque hayan vencido después y sin incorporar descuentos generales creados después (RN-RES-003, GAP-018), y cuando corresponda permitir registrar y reflejar un descuento adicional autorizado por fidelización o por otro motivo definido por el negocio. El sistema debe dejar visible qué descuentos fueron aplicados, en qué orden y sobre qué valor se calcularon.
- Resultado esperado: Valor final de cobro calculado de forma consistente y trazable.
- Reglas relacionadas: RN-RES-002, RN-RES-003
- Excepciones conocidas: El orden de aplicación, la acumulación, los topes y los motivos habilitados deben obedecer a la parametrización configurada por el Administrador del tenant y fijada para la reserva al crearla, salvo el descuento adicional expresamente autorizado para esa reserva (GAP-018).
- Estado: CONFIRMADO
...
- Alcance por actor en Fase 1:
  - Cliente final: puede registrar su pago por transferencia adjuntando el comprobante, según el tipo y medio de pago habilitados, y aplicar su saldo a favor (GAP-015).
  - Colaborador operativo: puede consultar pagos, registrar la recepción de dinero en efectivo, cargar comprobantes en nombre del cliente con trazabilidad del usuario que realiza la carga, aplicar saldo a favor por cuenta del cliente (GAP-015) y validar o rechazar comprobantes cuando disponga del permiso Validar comprobantes (G5).
  - Administrador del tenant: puede consultar, registrar la recepción de dinero en efectivo, cargar comprobantes en nombre del cliente con trazabilidad, aplicar saldo a favor por cuenta del cliente (GAP-015), validar o rechazar pagos y comprobantes, decidir el tratamiento de valores abonados y autorizar o registrar devoluciones monetarias según las reglas de este PDR (G5).
...
- Reglas relacionadas: RN-RES-004, RN-RES-006, RN-RES-006A, RN-RES-006B, RN-RES-006C, RN-RES-006D, RN-RES-007, RN-RES-009, RN-CAJ-001
...
- Comportamiento esperado: El alta debe exigir nombre comercial, identificador único, estado inicial, zona horaria oficial, país, nombre del primer Administrador del tenant, correo electrónico, contraseña inicial y confirmación de contraseña, que deben coincidir; esa contraseña inicial es una credencial temporal conforme a la sección 9. La inactivación debe registrar motivo, conservar información histórica y auditoría, impedir nuevas reservas, pagos, ventas y demás operaciones comerciales, revocar de inmediato los accesos de operación normal de todos los usuarios del tenant, conservar para el Administrador del tenant solo un acceso restringido para gestionar obligaciones pendientes y registrar las devoluciones y movimientos financieros necesarios con auditoría, y suspender los plazos operativos del tenant y sus cancelaciones automáticas, sin suspender los temporizadores de seguridad ni los plazos de contingencia definidos en la sección 9 (GAP-001). Las reservas confirmadas o con pagos recibidos afectadas se gestionan conforme a la sección 9 (E6). La inactivación no bloquea al Administrador de plataforma ni le otorga acceso a los datos del tenant. Al reactivarse, cada plazo continúa con el tiempo restante que tenía y los usuarios inactivados individualmente siguen inactivos. La reactivación debe ser una acción explícita que registre responsable, fecha, hora y motivo (G4, G14).
...
- Comportamiento esperado: Toda salida debe definir fecha, hora de inicio y hora de finalización estimada. Cuando el transporte sea obligatorio, la capacidad efectiva de la salida corresponde al menor valor entre la capacidad del tour y la capacidad total de los vehículos asignados. Un mismo vehículo puede asignarse a diferentes salidas siempre que sus intervalos programados no se superpongan. Al modificar la capacidad del tour o la asignación de transporte, el sistema debe impedir que la nueva capacidad efectiva sea inferior a los cupos ya apartados o asignados. La hora de finalización estimada es independiente de la hora real de finalización registrada durante la ejecución. El Administrador del tenant puede cancelar una salida Programada; sus reservas se gestionan conforme a RN-EJE-002, y toda propuesta de reprogramación pendiente hacia esa salida queda sin efecto conforme a FINAL-010. Una salida Programada sin reservas puede cambiar su fecha u hora directamente, respetando las reglas de transporte y de solapamiento de vehículos. Una salida Programada con reservas no puede cambiar su fecha u hora: el Administrador del tenant cancela la salida original por una causa no atribuible al cliente, programa la nueva salida y la propone a las reservas afectadas conforme a RN-EJE-002. El plazo L1 de 24 horas corre desde la cancelación de la salida original, que inicia el episodio de reprogramación con su límite máximo computable de 96 horas (FINAL-011), que queda definitivamente Cancelada y nunca se modifica para representar la nueva fecha. Cada reserva decide de forma independiente: si acepta, la misma reserva pasa a la nueva salida; si rechaza o no responde dentro del plazo aplicable, se cancela con devolución del 100 % de los valores validados; ningún cliente se traslada unilateralmente (GAP-011, FINAL-003) (decisiones del equipo G3, H3 y H8 — 2026-09-23).
...
- Comportamiento esperado: La cancelación la registran un Colaborador operativo o el Administrador del tenant, con la causal y la trazabilidad correspondientes. La reserva pasa a Cancelada, que es terminal y no puede reactivarse, y su cupo se libera. Si existen valores pagados y validados, primero se aplica la política de cancelación vigente del servicio: si establece una penalidad válida para el momento en que el cliente cancela, esta se descuenta de los valores pagados y validados, y el resultado es el monto reembolsable (RN-RES-008). Sobre ese monto reembolsable, el Administrador del tenant dispone de 24 horas corridas para decidir entre la devolución del 100 % o su registro del 100 % como saldo a favor dentro del tenant; si no registra una decisión dentro del plazo, Multitour determina automáticamente la devolución del 100 % del monto reembolsable, que queda pendiente de ejecución y se notifica conforme a RN-RES-008 (AC-02). Ejemplo: valor pagado $300.000 y penalidad aplicable del 50 %; la penalidad es $150.000 y la decisión financiera se aplica sobre el monto reembolsable de $150.000. Esta regla no aplica a cancelaciones por causa no atribuible al cliente, en las que no hay penalidad y corresponde reprogramación o devolución del 100 % (decisiones del equipo L8 y Q4 — 2026-09-23). Un comprobante aprobado después de la cancelación sigue el tratamiento de RN-RES-006C para comprobantes aprobados después de la cancelación (GAP-003).
...
- Excepciones conocidas: El cliente final no puede cancelar desde la autogestión en Fase 1. No aplica a reservas con la marca Pendiente de respuesta de reprogramación; en ese caso el cliente rechaza la propuesta conforme a RN-EJE-002.
- Estado: CONFIRMADO
...
- Regla: La reserva puede incluir descuentos cuando aplique, tanto por promociones vigentes sobre tours u otros servicios como por descuentos adicionales autorizados al momento de cobro o pago, por ejemplo por fidelización u otro motivo definido por el negocio. Los descuentos deben ser parametrizables y administrables por el rol Administrador del tenant, quien define su configuración, vigencia, aplicación, prioridad, acumulación, topes y condiciones de uso según la necesidad del negocio. Como regla base de Fase 1, al crear la reserva primero se evalúa la existencia de descuentos vigentes del servicio, que quedan fijados para ella conforme a RN-RES-003; si existe más de uno aplicable, el sistema debe resolverlos por prioridad configurada. El descuento adicional autorizado solo puede aplicarse después del descuento vigente, debe registrar motivo y responsable de autorización y debe quedar trazabilidad del valor final calculado. Cuando la configuración combine descuentos porcentuales y de valor fijo, el sistema debe respetar la base de cálculo parametrizada para cada descuento, dejando visible si se aplica sobre el valor original o sobre el subtotal posterior al descuento anterior.
- Estado: CONFIRMADO

### RN-RES-003

- Regla: Deben persistirse valor proyectado y valor final. Los descuentos generales aplicables a una reserva quedan fijados como parte de su contexto comercial al momento de crearla: un descuento general creado después no se aplica automáticamente a reservas existentes, y un descuento que vence después no desaparece automáticamente de una reserva existente. Si una modificación posterior cambia viajeros, servicios u otros datos que afectan el cálculo, el valor se recalcula utilizando los descuentos y reglas comerciales fijados para esa reserva, sin consultar nuevamente los descuentos generales vigentes en ese momento. Un descuento adicional expresamente autorizado para esa reserva sí puede incorporarse y provoca un nuevo cálculo (GAP-018). El contexto comercial fijado no se limita a los descuentos que produjeron un valor distinto de cero: conserva, para los componentes existentes desde la creación, su tarifa o precio base fijado, las reglas generales de descuento necesarias para recalcular la reserva, su orden de aplicación, su acumulación y sus topes, incluso si un descuento vence después. Cuando una modificación autorizada agrega un servicio, transporte u otro componente no incluido originalmente, su tarifa o precio base se fija con el valor vigente al momento de esa modificación y queda fijado desde entonces; para sus descuentos se usan únicamente las reglas generales del contexto original que resulten aplicables a ese componente, sin incorporar descuentos o promociones generales creados después, y puede agregarse un descuento adicional expresamente autorizado para la reserva. Los pagos posteriores no vuelven a consultar el catálogo (FINAL-004).
- Estado: CONFIRMADO

### RN-RES-004

- Regla: La posibilidad de modificar o cancelar una reserva depende de los términos y condiciones configurados para la actividad o servicio correspondiente. No existe una única regla temporal general para todas las actividades. Los tiempos límite dependen del tour y del tipo de cambio solicitado, y deben ser parametrizables. Cuando una reserva se modifica antes de ejecución, deben recalcularse valores, descuentos, transporte y disponibilidad utilizando los descuentos y reglas comerciales fijados para la reserva al crearla, sin consultar nuevamente los descuentos generales vigentes en ese momento (RN-RES-003, GAP-018, FINAL-004). Como regla base de Fase 1, la modificación debe conservar trazabilidad del valor original, del valor recalculado y del saldo resultante por cobrar, compensar o devolver.
- Estado: CONFIRMADO
...
- Regla: Cuando el cliente presenta un comprobante de pago dentro del plazo establecido, el comprobante queda En validación y la reserva no puede ser cancelada automáticamente por vencimiento mientras el comprobante permanezca en ese estado, salvo al alcanzarse la hora programada de inicio de la salida conforme a RN-EJE-001 (C3, G1, H1). Los comprobantes deben revisarse dentro de un plazo máximo de 24 horas corridas contado desde su presentación; la validación puede realizarla cualquier usuario activo del tenant que disponga del permiso Validar comprobantes. Si un comprobante supera las 24 horas sin decisión, continúa En validación, se marca como revisión vencida y el sistema muestra una alerta en el panel de todos los usuarios activos autorizados para validar comprobantes. El vencimiento de ese plazo no cancela la reserva, no rechaza automáticamente el comprobante ni libera el cupo asociado (D6, E14). Si el comprobante es rechazado, el sistema verifica nuevamente el plazo de pago original: si continúa vigente, el cliente puede presentar un nuevo comprobante dentro del tiempo restante; si ya venció, la reserva se cancela automáticamente y se libera el cupo. El rechazo no genera un plazo adicional de subsanación y ningún usuario puede reactivar manualmente una reserva cancelada por esta causa (E5). Si un comprobante presentado dentro del plazo se aprueba después del vencimiento por un monto verificado insuficiente para cumplir la condición exigida —la confirmación, el saldo o la diferencia—, no se genera un nuevo plazo: se aplica de inmediato la consecuencia que habría correspondido al vencimiento sin el monto requerido, es decir, la cancelación automática con liberación del cupo, y los valores validados pasan al tratamiento pendiente (GAP-004). La inactivación del tenant no elimina una consecuencia económica cuyo plazo ya había vencido antes de la inactivación: si un comprobante que ya estaba En validación se rechaza, o se aprueba por un monto insuficiente para cumplir el requisito ya vencido, mientras el tenant está inactivo y antes de la hora programada de la salida, la reserva se cancela de inmediato conforme a esta regla; esta cancelación no se considera asociada a un plazo congelado. Si durante la inactivación ya se alcanzó la hora programada y la salida fue cancelada por una causa no atribuible al cliente (I1), prevalece esa causa: la reserva no se cancela por incumplimiento económico y se gestiona con reprogramación o devolución del 100 % conforme a RN-EJE-002 (FINAL-001). Esta regla aplica tanto al plazo de pago de la confirmación como al plazo del saldo (E1).
- Estado: CONFIRMADO

Tratamiento pendiente de valores abonados (GAP-05; decisiones del equipo D1 y E16 — 2026-09-23):
Cuando una reserva sea cancelada por incumplimiento del pago —por vencimiento del plazo de confirmación, del plazo del saldo o de una diferencia pendiente, o al alcanzarse la hora programada de inicio de la salida con pagos pendientes— y existan valores previamente abonados y validados, estos quedan en condición de tratamiento pendiente. Lo mismo aplica al valor de un comprobante aprobado después de una cancelación por incumplimiento del pago. El Administrador del tenant dispone de 24 horas corridas, contadas desde que el dinero queda efectivamente reconocido —al cancelarse la reserva si ya existían valores validados, o al aprobarse un comprobante después de la cancelación—, para decidir entre devolver al cliente el 100 % del valor abonado y validado o registrarlo en su totalidad como saldo a favor dentro del tenant, y la decisión debe quedar registrada. Si transcurre ese plazo sin decisión, Multitour determina automáticamente la devolución del 100 % como tratamiento predeterminado; esta determinación no implica que el dinero haya sido devuelto: la devolución queda pendiente de ejecución y todos los Administradores del tenant activos son notificados conforme a RN-RES-008 para completarla y registrar el movimiento correspondiente. Una devolución no se considera completada hasta que el movimiento haya sido efectivamente procesado. El plazo se suspende mientras el tenant esté inactivo y continúa con el tiempo restante después de su reactivación. No existen retenciones, penalidades ni otras condiciones comerciales no definidas (decisiones del equipo D1, E16, G5, G7, H4 y H5 — 2026-09-23).

Comprobante aprobado después de la cancelación (decisión del equipo GAP-003 — 2026-09-23):
El valor de un comprobante aprobado después de la cancelación de su reserva hereda la causa y el tratamiento de esa cancelación, sin reactivar la reserva: si la cancelación fue por una causa no atribuible al cliente, se devuelve el 100 % (RN-EJE-002); si fue solicitada por el cliente, la política de cancelación de RF-021 se calcula una sola vez sobre el conjunto de valores reconocidos de la reserva: el monto verificado se incorpora al total validado, se recalcula el monto reembolsable final con la misma cancelación y la misma política, una penalidad fija se aplica una sola vez y solo se determina la diferencia adicional; si el tratamiento de la cancelación ya se había decidido o determinado, el incremento sigue ese mismo tratamiento —devolución o saldo a favor— sin iniciar una segunda decisión de 24 horas, y si la decisión sigue en curso, se toma con el monto actualizado (FINAL-005). Por ejemplo, con un total validado de $100.000, una penalidad fija de $20.000 y un reembolsable de $80.000, si después se aprueba un comprobante de $50.000, el total validado es $150.000, la penalidad sigue siendo $20.000 y el reembolsable final es $130.000; si fue por incumplimiento del pago, aplica el tratamiento pendiente anterior.
...
- Regla: Toda devolución derivada de una cancelación, modificación o novedad extraordinaria debe seguir tres decisiones funcionales separadas: determinación del valor potencial a devolver, autorización de la devolución y ejecución efectiva de la salida de dinero. La determinación del valor potencial se calcula según la condición comercial parametrizada del servicio y puede dar como resultado devolución total, parcial o inexistente, salvo en cancelaciones por causas no atribuibles al cliente, en las que la devolución es del 100 % de los valores pagados y validados (G12). Toda devolución determinada debe ejecutarse y registrarse dentro de un plazo máximo de 5 días hábiles. Si no se completa en ese plazo, queda marcada como vencida y se genera una alerta en el panel de los Administradores del tenant activos; la devolución sigue siendo una obligación pendiente hasta su ejecución (L3). Este plazo no se congela durante la inactivación del tenant (GAP-001). La autorización solo puede realizarla el Administrador del tenant. Cuando la devolución la determina automáticamente el sistema, esa determinación cuenta como autorización y la devolución queda lista para ejecutarse. Cuando Multitour determina automáticamente una devolución por vencer el plazo de decisión de 24 horas —valores abonados después de una cancelación (RN-RES-006C), excedente por disminución del valor de la reserva (RN-RES-004), monto reembolsable de una cancelación solicitada por el cliente (RF-021) o solicitud de devolución de saldo a favor (RN-RES-009)—, genera una alerta persistente en el panel y envía un correo electrónico a todos los Administradores del tenant activos, informando la reserva, el cliente, el monto, el motivo y que la devolución está pendiente de ejecución; la determinación no implica que el dinero haya sido devuelto, el fallo del correo no modifica la decisión financiera y cualquier fallo de notificación queda registrado (AC-02). La ejecución efectiva de la salida de dinero debe quedar asociada a un movimiento identificable de caja y puede ser registrada por el Administrador del tenant o por el Colaborador operativo únicamente cuando exista autorización previa trazable. Si solo existe compensación futura o saldo a favor sin salida efectiva de dinero, el caso no debe marcarse como devolución ejecutada.
- Estado: CONFIRMADO

### RN-RES-009

- Regla: El saldo a favor corresponde a valores previamente pagados y validados que permanecen disponibles para el cliente dentro del tenant que los originó. Se genera cuando una modificación, cancelación o novedad extraordinaria produce un valor a compensar sin salida efectiva inmediata de dinero, por el tratamiento pendiente de RN-RES-006C, o por el excedente de un pago validado sobre el valor pendiente de la reserva conforme a RN-RES-006A (H11). En Fase 1 no tiene fecha de vencimiento y permanece disponible hasta ser utilizado o devuelto. El cliente puede aplicarlo total o parcialmente a una nueva reserva del mismo tenant; lo aplica el propio cliente desde su flujo de pago, o un Colaborador operativo o el Administrador del tenant por cuenta del cliente al registrar el pago, y queda auditado el monto consumido (GAP-015); el valor aplicado se considera pago validado y cuenta para cumplir el abono mínimo o el pago total. El cliente puede solicitar posteriormente la devolución del saldo disponible desde su panel, o un Colaborador operativo o el Administrador del tenant puede registrar la solicitud en su nombre. El Administrador del tenant dispone de 24 horas corridas desde la solicitud para autorizarla o rechazarla de forma justificada; si no registra una decisión dentro de ese plazo, Multitour autoriza automáticamente la devolución por el monto solicitado que continúe disponible y la notifica conforme a RN-RES-008. Una vez autorizada, la devolución queda pendiente de ejecución, aplica el plazo máximo de 5 días hábiles y no se considera completada hasta que el movimiento haya sido efectivamente procesado (GAP-014). El saldo a favor no puede transferirse ni utilizarse entre tenants diferentes, no se registra como movimiento de caja mientras no exista devolución ejecutada y debe registrar valor, origen, fecha, actor responsable, tenant, reserva de origen y consumos realizados (decisión del equipo E17 — 2026-09-23).
- Estado: CONFIRMADO
...
- Regla: El transporte debe manejar una tarifa parametrizada por persona. La tarifa puede variar dependiendo del servicio o actividad asociada, y cada tour puede tener una tarifa fija propia por persona para el trayecto correspondiente. Si la reserva se modifica debe recalcularse el valor de transporte que corresponda a la nueva configuración: el transporte existente conserva la tarifa fijada para la reserva y un trayecto agregado fija la tarifa vigente al agregarlo (RN-RES-003, FINAL-004).
- Estado: CONFIRMADO

### RN-EJE-001

- Regla: Al alcanzarse la hora programada de inicio de una salida, Multitour bloquea nuevos pagos, abonos y comprobantes asociados a ella y cancela automáticamente las reservas que no cumplan las condiciones económicas necesarias para participar —pagos, saldos o diferencias pendientes, o un comprobante necesario para completar el pago todavía En validación—, liberando sus cupos. Estas acciones no dependen del registro manual del inicio real. La hora programada de una salida ya cancelada o interrumpida no provoca cancelaciones por incumplimiento de pago (Q3). Si la hora programada de inicio se alcanza mientras el tenant está inactivo, no se aplica lo anterior: Multitour cancela automáticamente la salida por una causa no atribuible al cliente, sin aplicar cancelaciones por incumplimiento de pago ni vencimientos asociados a la salida original, y sus reservas se gestionan conforme a RN-EJE-002 (I1). Si un comprobante de una reserva cancelada por esta causa se aprueba después, los valores reconocidos se tratan conforme al tratamiento pendiente de RN-RES-006C y no reactivan la reserva. Un retraso en el inicio real de la salida no extiende los plazos económicos (G1, H1). El inicio real y la finalización de la salida los registran en Multitour el Administrador del tenant o un Colaborador operativo con el permiso Gestionar ejecución de salidas, después del control operativo previo realizado por el guía (E11, G5, H9). El inicio real no puede registrarse antes de la hora programada de inicio: debe ser igual o posterior a ella (GAP-010). En la regularización de una salida pasada puede registrarse una hora real de inicio anterior a la hora programada cuando así ocurrió, con motivo obligatorio y auditoría de quién y cuándo la registró, conservando la hora programada y la hora real reportada; esa hora real es solo evidencia operacional y no modifica vencimientos, bloqueo de pagos, cancelaciones económicas ni demás temporizadores, que siguen gobernados por la hora programada (FINAL-006). Al registrarse el inicio real, pasan a En ejecución únicamente las reservas que continúan elegibles: Confirmadas con situación financiera Pago completo. Al registrarse la finalización, las reservas En ejecución pasan automáticamente a Finalizada; esta transición no aplica cuando se registra la interrupción de la salida, cuyas reservas se gestionan conforme a RN-EJE-002. Si se alcanza la hora programada de inicio y la salida sigue Programada, Multitour genera una alerta en el panel de los Administradores del tenant activos y de los usuarios con el permiso Gestionar ejecución de salidas. Si se alcanza la hora de finalización estimada sin cierre operativo, la salida queda identificada como pendiente de regularización. El Administrador del tenant o un usuario con el permiso Gestionar ejecución de salidas debe registrar posteriormente lo ocurrido con la información real disponible: salida ejecutada y finalizada, cancelada o interrumpida. El sistema no marca una salida como Finalizada solo por el paso del tiempo. Toda regularización conserva la hora real reportada, el responsable, la fecha del registro y su trazabilidad (J3, L4). Si una persona no se presenta y no hubo aviso oportuno al guía, este puede conceder hasta 10 minutos adicionales antes de iniciar. Si transcurren esos 10 minutos sin presentación ni aviso oportuno, el servicio correspondiente se mantiene como cobrado aunque la persona no participe en la actividad.
- Estado: CONFIRMADO

### RN-EJE-002

- Regla: En ejecución no se permiten ajustes ordinarios posteriores a la reserva inicial. Solo puede registrarse una cancelación extraordinaria del tour por emergencia, la cual debe quedar justificada por el Administrador del tenant o un usuario con el permiso Gestionar ejecución de salidas y debe conducir a una decisión de reagendamiento o devolución.
- Estado: CONFIRMADO

Observación funcional base de Fase 1:
Cuando una salida se cancele antes de su inicio, o una salida ya iniciada no pueda completarse, por decisión, contingencia, emergencia o imposibilidad operativa no atribuible al cliente, el tenant debe registrar la causal y, si la salida ya había iniciado, la interrupción. El Administrador del tenant tiene un plazo máximo de 24 horas corridas desde la cancelación o interrupción para proponer al cliente una nueva salida con disponibilidad. Si al cancelarse o interrumpirse la salida no existe una alternativa inmediata, el Administrador del tenant conserva las 24 horas completas para programar o encontrar y proponer otra salida; si declara antes del vencimiento que no habrá alternativa, la reserva puede cancelarse de inmediato. Si vencen las 24 horas sin propuesta, la reserva se cancela y se devuelve el 100 % de los valores efectivamente pagados y validados; la reserva no puede permanecer indefinidamente asociada a una salida cancelada o interrumpida. Este plazo no se congela durante la inactivación del tenant (L1, GAP-001, GAP-019). Con el tenant activo, también comienza un nuevo plazo L1, cuya duración efectiva es el menor entre 24 horas y el tiempo restante del episodio de reprogramación (FINAL-011), cuando una propuesta pendiente queda sin efecto porque su salida propuesta se cancela; con el tenant inactivo, la cancelación de la salida propuesta conforme a I1 no abre un nuevo plazo L1 (FINAL-010). Desde el momento en que la salida se cancela o se interrumpe por una causa no atribuible al cliente, todos los plazos económicos de sus reservas quedan congelados (plazo de pago inicial, ampliaciones vigentes, plazo del saldo y diferencias pendientes); si el cliente acepta la nueva salida, continúan con el tiempo que les quedaba antes de la suspensión, sin superar la hora programada de inicio de la nueva salida (Q3). Si el cliente acepta y existe disponibilidad en la nueva salida, se conserva la misma reserva, sus pagos y su historial; si la salida ya había iniciado, se registra la ejecución interrumpida y la reserva regresa excepcionalmente de En ejecución a Confirmada con la nueva salida asignada. La reprogramación no está sujeta a las restricciones temporales de la política de cambios (E7). Si el cliente no acepta la reprogramación, la reserva pasa a Cancelada y se devuelve el 100 % de los valores pagados y validados, sin penalidades, retenciones ni devoluciones parciales. Una reserva cancelada no puede reactivarse (decisiones del equipo G12, G18 y H2 — 2026-09-23).

Plazo de respuesta a la reprogramación (decisión del equipo I2 — 2026-09-23):
La propuesta de una nueva salida solo puede enviarse si esa salida tiene capacidad suficiente para los viajeros de la reserva. Al enviarla, Multitour aparta en la salida propuesta los cupos correspondientes durante el plazo de respuesta. El apartado termina con el primero de estos eventos: si el cliente acepta, los cupos apartados quedan asociados a la reserva reprogramada; si el cliente rechaza, si vence el plazo de respuesta, si llega la hora programada de la nueva salida sin aceptación, si la propuesta queda sin efecto porque esa salida se cancela o si se alcanza el límite del episodio de reprogramación, los cupos se liberan (K3, FINAL-010, FINAL-011). El cliente dispone de hasta 72 horas corridas desde la notificación de la propuesta para aceptarla o rechazarla, sin que el vencimiento supere la hora programada de inicio de la nueva salida propuesta ni el límite del episodio de reprogramación (FINAL-011); si esa hora se alcanza durante la inactivación del tenant y la salida propuesta se cancela conforme a I1, la propuesta queda sin efecto y la reserva se cancela conforme a la regla de propuesta sin efecto de esta sección (FINAL-010). El cliente responde desde su panel; también puede registrar la respuesta un Colaborador operativo o el Administrador del tenant cuando llegue por un canal externo, conservando la evidencia, el actor y la fecha y hora (GAP-008). Mientras espera la respuesta, la reserva se identifica con la marca Pendiente de respuesta de reprogramación y deja de estar asociada operativamente a la salida cancelada o interrumpida. Si el cliente acepta y existe disponibilidad, se conserva la misma reserva, sus pagos y su historial y se asigna la nueva salida. Si rechaza la propuesta o no responde dentro del plazo, la reserva se cancela y se devuelve el 100 % de los valores efectivamente pagados y validados. Al inactivarse el tenant, este plazo se congela siempre: la falta de respuesta durante la inactivación no consume el tiempo restante ni provoca la cancelación, y al reactivarse el tenant se reanuda únicamente el tiempo restante de las 72 horas; durante ese mismo periodo se congela también el tiempo restante del episodio de reprogramación, que se reanuda igualmente (FINAL-011). Durante la inactivación, el Administrador del tenant, con su acceso restringido, puede registrar una respuesta que el cliente haya enviado voluntariamente por un canal externo, con evidencia, actor y fecha y hora; una respuesta válida produce efecto inmediato y termina la espera (FINAL-002). Mientras dura el plazo de respuesta, los plazos económicos de la reserva permanecen congelados; si el cliente acepta la nueva salida, continúan con el tiempo que les quedaba antes de la suspensión, sin superar en ningún caso la hora programada de inicio de la nueva salida (L2).

Propuesta de reprogramación sin efecto (decisión del equipo FINAL-010 — 2026-09-23):
Toda propuesta de reprogramación pendiente queda automáticamente sin efecto si la salida propuesta se cancela o deja de ser viable antes de que la reserva haya completado el cambio hacia ella, por cualquier cancelación válida de esa salida: la realizada por el Administrador del tenant, la regularización como no realizada o la cancelación conforme a I1. Esto no cuenta como rechazo del cliente ni como falta de respuesta: termina el plazo de 72 horas de esa propuesta, los cupos apartados se liberan de inmediato (K3) y la reserva no puede permanecer vinculada a la salida cancelada. Si el tenant está activo, comienza un nuevo plazo L1 desde la cancelación de la salida propuesta, cuya duración efectiva es el menor entre 24 horas corridas y el tiempo restante del episodio de reprogramación, sin esperar el límite del episodio si ese plazo vence antes (FINAL-011), para proponer otra alternativa; una nueva propuesta genera un nuevo plazo de respuesta calculado conforme a FINAL-011, sin reutilizar el tiempo restante de la anterior, y si no se propone otra alternativa dentro de ese plazo L1, la reserva se cancela por una causa no atribuible al cliente con devolución del 100 % de los valores validados. Si la salida propuesta alcanza su hora programada mientras el tenant está inactivo y se cancela conforme a I1, no se inicia un nuevo plazo L1 ni puede encadenarse otra propuesta durante esa inactivación: la reserva pasa a Cancelada por una causa no atribuible al cliente, con devolución del 100 % de los valores validados, y la reactivación posterior del tenant no la revive, porque Cancelada es terminal (FINAL-010).

Límite del episodio de reprogramación (decisión del equipo FINAL-011 — 2026-09-23):
Cuando una salida original se cancela o se interrumpe por una causa no atribuible al cliente, se inicia para cada reserva afectada un único episodio de reprogramación, con un límite máximo computable de 96 horas, contado desde la cancelación o interrupción original, cuyo cómputo solo se pausa mientras una propuesta pendiente tenga su plazo de respuesta congelado por la inactividad del tenant. Dentro de ese límite, el Administrador del tenant dispone de hasta 24 horas para generar la primera propuesta (L1) y el cliente de hasta 72 horas para responder (I2). Las propuestas sustitutas no reinician el límite: solo pueden enviarse mientras el límite no haya vencido, y el plazo de respuesta de cualquier propuesta es el menor entre 72 horas corridas desde su notificación, el tiempo restante hasta el límite del episodio y la hora programada de inicio de la salida propuesta. Si se alcanza el límite sin una alternativa aceptada, la reserva pasa a Cancelada por una causa no atribuible al cliente, con devolución del 100 % de los valores validados; se liberan todos los cupos apartados relacionados y no se admiten nuevas propuestas en ese episodio. Cuando el cliente acepta una propuesta y la reserva queda efectivamente trasladada a la nueva salida, el episodio termina; si esa nueva salida se cancela o se interrumpe después por otra causa no atribuible al cliente, constituye un nuevo incidente que inicia un nuevo episodio con su propio límite. Con el tenant inactivo: si todavía no existe una propuesta pendiente, el plazo L1 y el cómputo del episodio siguen corriendo, y si L1 vence sin propuesta, la reserva se cancela por una causa no atribuible al cliente, con liberación de los cupos correspondientes y devolución del 100 % de los valores validados; si ya existe una propuesta pendiente, se congelan el plazo de respuesta del cliente y el tiempo restante del episodio durante exactamente el mismo periodo, la falta de respuesta durante la inactividad no consume ninguno de los dos y, si el tenant se reactiva antes de que la salida propuesta se cancele, ambos continúan con su tiempo restante; si la salida propuesta alcanza su hora durante la inactividad, prevalece FINAL-010: se cancela conforme a I1, la propuesta queda sin efecto, se liberan sus cupos, termina el plazo de respuesta y la reserva se cancela de inmediato por una causa no atribuible al cliente con devolución del 100 %, sin nuevo plazo L1 y sin esperar la reactivación ni el límite del episodio (FINAL-011).

Salida alcanzada durante la inactivación del tenant (decisión del equipo I1 — 2026-09-23):
Si la fecha y hora programadas de una salida se alcanzan mientras el tenant está inactivo, Multitour cancela automáticamente la salida por una causa no atribuible al cliente, sin aplicar cancelaciones por incumplimiento de pago ni vencimientos asociados a la salida original. Sus reservas pueden reprogramarse conforme a esta regla. Si la salida cancelada era la salida propuesta en una reprogramación pendiente, esa propuesta queda sin efecto y la reserva correspondiente se cancela con devolución del 100 %, sin un nuevo plazo L1 (FINAL-010). Cuando se reprograma una reserva pendiente de pago, sus plazos operativos congelados continúan con el tiempo restante, sujetos al límite absoluto de la hora programada de inicio de la nueva salida. La reactivación del tenant no reactiva una salida cuya hora programada ya haya transcurrido.

Emergencia personal del cliente durante la ejecución (decisiones del equipo H7 y AB-01 — 2026-09-23):
Cuando, durante una salida iniciada, el cliente o una persona de su reserva no pueda continuar por una emergencia personal, el Administrador del tenant o un usuario con el permiso Gestionar ejecución de salidas registra el caso como novedad de ejecución. El registro de la novedad no cancela la reserva ni genera por sí mismo una devolución. Al registrarse la novedad, Multitour calcula inmediatamente el monto reembolsable aplicando la política de cancelación o compensación vigente del servicio para ese supuesto, sin requerir una decisión adicional del Administrador del tenant:
- Si la política no establece devolución para ese supuesto, el monto reembolsable es $0, no se genera devolución y la reserva continúa su cierre normal hasta Finalizada, conservando la novedad en su historial.
- Si la política establece una devolución total o parcial, Multitour determina automáticamente el monto; esa determinación cuenta como autorización de la devolución conforme a RN-RES-008, y la devolución queda pendiente de ejecución dentro del plazo máximo de 5 días hábiles.
...
- Un cambio de zona horaria no puede activarse mientras exista una caja Abierta o Pendiente de cierre. Después del cambio, cada movimiento se asigna a la caja de su fecha local según la nueva zona horaria; si ya existe una caja para esa fecha, se utiliza esa misma caja conforme a las reglas de movimientos posteriores al cierre y de reapertura, sin crear una segunda (sección 9, FINAL-007).
- Si durante un día calendario debe registrarse un movimiento financiero no efectivo —por ejemplo, una transferencia validada o una devolución ejecutada por transferencia— y todavía no existe la caja de ese día, Multitour crea automáticamente la caja correspondiente. Esta creación no representa una apertura física de efectivo, no requiere base inicial y no modifica el efectivo esperado. La caja creada automáticamente queda en estado Abierta, con su origen identificado como creación automática para movimientos no efectivos, y puede recibir entradas y salidas no efectivas durante ese día. Si ese mismo día se requieren movimientos en efectivo, esa misma caja debe pasar por la apertura operativa antes de registrarlos; no puede existir una segunda caja para el mismo tenant y fecha (L10, Q6). Si al finalizar el día calendario del tenant la caja creada automáticamente nunca tuvo apertura operativa ni movimientos en efectivo, Multitour la cierra automáticamente, sin intervención de un usuario, conservando sus movimientos no efectivos; el cierre queda auditado como cierre automático y la caja participa normalmente en la consolidación y los reportes. Si tuvo apertura operativa, debe cerrarse formalmente por el Administrador del tenant o por un Colaborador operativo con el permiso Gestionar caja (AB-02).
- Si al finalizar el día calendario del tenant una caja con apertura operativa no ha sido cerrada formalmente, deja de aceptar movimientos y queda con la marca Pendiente de cierre, sin cierre automático ni efectivo final calculado por el sistema; se genera una alerta en el panel de los Administradores del tenant activos y de los usuarios con el permiso Gestionar caja, y la caja del día siguiente opera de forma independiente. La caja marcada debe cerrarse formalmente por esos mismos actores (GAP-012).
...
Observación:
Toda corrección o movimiento posterior al cierre que afecte el efectivo físico requiere reabrir la caja conforme a esta regla, con justificación obligatoria y trazabilidad de la acción realizada; los movimientos no efectivos posteriores al cierre se registran sin reabrirla (G13, GAP-013).
...
- Zona horaria oficial y país del tenant, modificables por el Administrador del tenant con efecto prospectivo; el cambio de zona horaria no puede activarse con una caja Abierta o Pendiente de cierre (G14, R2, FINAL-007).
...
Ninguna otra parametrización funcional debe asumirse como obligatoria de Fase 1 si no queda incorporada mediante una nueva versión de este PDR. No son parametrizables: el plazo de revisión de comprobantes (24 horas corridas), la vigencia de los códigos y enlaces de recuperación (30 minutos), la vigencia de las credenciales temporales (72 horas), la vigencia de la autorización de acceso excepcional (24 horas), el plazo para decidir el tratamiento pendiente de valores abonados (24 horas corridas), el plazo de respuesta del cliente a una propuesta de reprogramación (72 horas corridas), el plazo del Administrador del tenant para proponer una reprogramación (24 horas corridas), el límite máximo computable del episodio de reprogramación (96 horas desde la cancelación o interrupción de la salida original, cuyo cómputo solo se pausa mientras una propuesta pendiente tenga su plazo de respuesta congelado por la inactividad del tenant), el plazo para decidir el tratamiento de un excedente por modificación o de una cancelación solicitada por el cliente (24 horas corridas) el plazo para resolver una solicitud de devolución de saldo a favor (24 horas corridas) y el plazo máximo de ejecución de una devolución (5 días hábiles). El tratamiento de valores abonados de una reserva cancelada por incumplimiento se decide caso por caso conforme a RN-RES-006C y no es una parametrización.
...
- Responsabilidades respaldadas por las fuentes:
  ...
  - ejecutar aperturas, cierres y reaperturas de caja con el permiso Gestionar caja
...
- Responsabilidades confirmadas:
  ...
  - registrar movimientos de caja de acuerdo con su responsabilidad operativa
  ...
  - registrar el inicio, la finalización, las interrupciones y las novedades de las salidas y regularizarlas, con el permiso Gestionar ejecución de salidas, sin cancelar salidas futuras Programadas (E11, G5, FINAL-008)
...
- Pendiente de pago a Cancelada: automáticamente, cuando vence el plazo total de pago —cuyo vencimiento efectivo es el menor valor entre el plazo configurado y la hora programada de inicio de la salida— sin pago validado que cumpla la condición de confirmación y sin comprobante En validación; cuando un comprobante es rechazado, o aprobado por un monto insuficiente, después de ese vencimiento (GAP-004); o al alcanzarse la hora programada de inicio de la salida, salvo que la salida ya haya sido cancelada o interrumpida (Q3). También cuando el cliente solicita la cancelación y la registran un Colaborador operativo o el Administrador del tenant (RN-RES-006, RN-RES-006C, RN-EJE-001, RF-021). También cuando su salida se cancela por una causa no atribuible al cliente y no se le propone una nueva salida dentro de las 24 horas corridas (RN-EJE-002, L1).
- Confirmada a Cancelada: automáticamente, cuando vence el plazo del saldo o de una diferencia pendiente sin que se haya completado y sin comprobante En validación; cuando un comprobante de ese pago es rechazado, o aprobado por un monto insuficiente, después del vencimiento (GAP-004); o al alcanzarse la hora programada de inicio de la salida con pagos, saldos o diferencias pendientes o con un comprobante todavía En validación, salvo que la salida ya haya sido cancelada o interrumpida (RN-RES-004, RN-EJE-001, Q3). También cuando el cliente solicita la cancelación y la registran un Colaborador operativo o el Administrador del tenant (RF-021), o por cancelación de la salida por una causa no atribuible al cliente cuando este no acepta la reprogramación o no recibe una propuesta dentro de las 24 horas corridas (RN-EJE-002, L1).
...
- En ejecución a Cancelada: cuando la salida se interrumpe por una causa no atribuible al cliente y el cliente no acepta la reprogramación o no recibe una propuesta dentro de las 24 horas corridas (L1), con devolución del 100 % de los valores pagados y validados (H2).
- Marca Pendiente de respuesta de reprogramación: se aplica a la reserva afectada por la cancelación o interrupción de su salida mientras el cliente decide sobre la nueva salida propuesta; no es un estado. Durante ese plazo, los cupos de los viajeros de la reserva quedan apartados en la salida propuesta (K3). Si el cliente acepta, la reserva se asocia a la nueva salida y, si estaba En ejecución, vuelve a Confirmada (H2, I2). Si la salida propuesta se cancela, la propuesta queda sin efecto y se liberan sus cupos: con el tenant activo, la reserva conserva la marca mientras corre un nuevo plazo L1, igual al menor entre 24 horas y el tiempo restante del episodio, y una nueva propuesta inicia un nuevo plazo de respuesta igual al menor entre 72 horas, el tiempo restante del episodio de reprogramación y la hora programada de la salida propuesta, sin reiniciar el límite del episodio ni garantizar 72 horas completas (FINAL-011); si la cancelación se produce conforme a I1 con el tenant inactivo, la reserva pasa a Cancelada (FINAL-010). La marca no puede durar más allá del límite máximo computable de 96 horas del episodio de reprogramación, contado desde la cancelación o interrupción de la salida original y cuyo cómputo solo se pausa mientras una propuesta pendiente tenga su plazo de respuesta congelado por la inactividad del tenant; las propuestas sustitutas no reinician ese límite (FINAL-011).
- Pendiente de pago, Confirmada o En ejecución a Cancelada: cuando la reserva tiene la marca Pendiente de respuesta de reprogramación y el cliente rechaza la propuesta o no responde dentro del plazo de respuesta aplicable, igual al menor entre 72 horas, el tiempo restante del episodio de reprogramación y la hora programada de la salida propuesta (FINAL-011); o cuando la propuesta queda sin efecto por la cancelación de su salida propuesta y, con el tenant activo, no se propone otra salida dentro del nuevo plazo L1, o de inmediato si esa cancelación se produce conforme a I1 con el tenant inactivo; o cuando se alcanza el límite máximo computable de 96 horas del episodio de reprogramación sin una alternativa aceptada (FINAL-011); en todos los casos, con devolución del 100 % de los valores pagados y validados (I2, FINAL-010).
...
- Mientras el tenant esté inactivo, los plazos operativos de las reservas quedan suspendidos y no se ejecutan las cancelaciones automáticas derivadas de plazos congelados; sí se aplican las consecuencias de plazos que ya habían vencido antes de la inactivación cuando se resuelve un comprobante, conforme a RN-RES-006C (FINAL-001); si se alcanza la hora programada de una salida, la salida se cancela y se aplica RN-EJE-002 (sección 9, I1).
...
- Programada a En ejecución: al registrarse el inicio real de la salida, que no puede ser anterior a su hora programada de inicio, salvo en la regularización histórica de una salida pasada, donde la hora real anterior se registra con motivo obligatorio y solo como evidencia operacional (GAP-010, FINAL-006).
- Cambio de fecha u hora: una salida Programada sin reservas puede cambiarlos directamente; una salida con reservas no se modifica, sino que se cancela por causa no atribuible al cliente y sus reservas reciben la propuesta de una nueva salida conforme a RF-020 y RN-EJE-002 (FINAL-003).
...
- Programada a Cancelada: cuando el Administrador del tenant cancela una salida futura antes de su inicio real; cuando el Administrador del tenant o un usuario con el permiso Gestionar ejecución de salidas regulariza como no realizada una salida cuya hora programada ya pasó (GAP-021); o automáticamente cuando su hora programada de inicio se alcanza mientras el tenant está inactivo (I1, L4); sus reservas se gestionan conforme a RN-EJE-002 y toda propuesta de reprogramación pendiente hacia esa salida queda sin efecto (FINAL-010). Una salida Cancelada no se reactiva.
- Inicio no registrado: al alcanzarse la hora programada de inicio con la salida en Programada, se genera una alerta en el panel de los Administradores del tenant activos y de los usuarios con el permiso Gestionar ejecución de salidas (L4).
- Pendiente de regularización: marca de la salida que supera su hora de finalización estimada sin cierre operativo; no es un estado ni cierra la salida (L4). Si la marca se mantiene más de 7 días calendario, el periodo de retención de los datos sensibles de sus reservas se cuenta desde la hora de fin estimada, y la salida sigue pendiente de regularización (Q1).
...
- Caja creada automáticamente: cuando debe registrarse un movimiento no efectivo, de entrada o de salida, en un día sin caja, la caja de ese día se crea automáticamente en estado Abierta, con origen automático, sin apertura física ni base; para movimientos en efectivo, esa misma caja pasa por la apertura operativa (L10, Q6, AB-02).
...
- Abierta a Cerrada: por el cierre formal diario o, en una caja creada automáticamente que nunca tuvo apertura operativa ni movimientos en efectivo, por cierre automático al finalizar el día calendario del tenant, auditado como tal (AB-02). Cerrada a Abierta: por reapertura con motivo obligatorio y trazabilidad completa, sin generar una segunda caja para la misma fecha.
- Pendiente de cierre: marca de una caja con apertura operativa que no fue cerrada formalmente al finalizar su día calendario; deja de aceptar movimientos, genera una alerta y se resuelve con el cierre formal; no es un estado (GAP-012).
...
- Privacidad y protección de información: CONFIRMADO PARA FASE 1. El sistema debe preservar la integridad de la información gestionada y respetar las políticas y normativa aplicable en Colombia para el tratamiento de la información, incluyendo datos personales, médicos o de emergencia asociados a actividades de riesgo. Se consideran datos sujetos a eliminación la información médica, el tipo de sangre, las restricciones físicas y los datos de contacto de emergencia utilizados durante la prestación del servicio. Estos datos se eliminan de los sistemas activos un año después de la finalización del servicio; si una salida supera 7 días calendario desde su hora de fin estimada y sigue sin regularizarse, el año se cuenta desde esa fecha y hora de fin estimada, sin que la salida se cierre automáticamente (Q1); para reservas canceladas, el periodo se cuenta desde su cierre definitivo, es decir, desde que se resuelven las obligaciones económicas derivadas de la reserva: cuando el tratamiento es saldo a favor, desde que ese saldo queda formalmente registrado a nombre del cliente, independientemente de cuándo se utilice; cuando es devolución, desde lo que ocurra primero entre la ejecución completada de la devolución y el vencimiento de su plazo máximo de 5 días hábiles; la devolución sigue siendo una obligación pendiente aunque el periodo de retención ya haya comenzado (L3). Si la reserva cancelada no tiene valores por tratar —porque no hubo pagos o porque la penalidad aplicable absorbe todo lo pagado—, el cierre definitivo ocurre en la fecha y hora de la cancelación. Si el cierre definitivo de una reserva cancelada queda pendiente porque un plazo de decisión está congelado por la inactivación del tenant, el año de retención se cuenta desde la fecha y hora de la cancelación como límite subsidiario, de modo que la inactivación nunca extiende indefinidamente la retención (GAP-002). El uso posterior de un saldo a favor tiene un ciclo financiero independiente y no extiende el periodo de conservación (G11). La eliminación queda trazada y no implica eliminar el histórico comercial de la reserva. Los consentimientos se conservan como evidencia y no están sujetos a esta eliminación automática, sin perjuicio de la política documental que les corresponda. Las copias de seguridad pueden conservar temporalmente información eliminada hasta completar su ciclo de retención de máximo 30 días; si un respaldo es restaurado, deben reaplicarse las reglas de retención vigentes. El acceso a datos sensibles requiere el permiso Consultar datos sensibles definido en la sección 9 y queda auditado. El Administrador de plataforma no tiene acceso ordinario a estos datos; cualquier acceso excepcional requiere autorización del Administrador del tenant propietario de la información o, en el acceso de emergencia de la sección 9, que su alcance incluya expresamente los datos sensibles con justificación específica; en ambos casos tiene alcance limitado y temporal y queda registrado en auditoría (GAP-020) (decisiones del equipo C4, E8, E21 y E22 — 2026-09-23). En enfoque multitenencia, estas políticas deben aplicarse sin exponer información sensible entre tenants.
...
- CA-005B: Al momento de cobrar o pagar deben reflejarse los descuentos generales fijados al crear la reserva, sin que un descuento general creado después se aplique ni uno que venza después desaparezca de la reserva, y, cuando corresponda, los descuentos adicionales autorizados, dejando visible el valor final de cobro, el orden de aplicación y el motivo del descuento adicional cuando exista.
- CA-005C: Debe ser posible modificar una reserva antes de la ejecución cuando la regla parametrizada lo permita, recalculando valores, descuentos, disponibilidad y saldo resultante con trazabilidad del cambio; los descuentos deben recalcularse con las reglas de descuento fijadas para la reserva al crearla y no con los descuentos generales vigentes al momento de la modificación. Si la modificación agrega viajeros a una reserva con cupo, los cupos adicionales deben asignarse en ese momento o la modificación no debe realizarse si no hay capacidad; si reduce los viajeros, los cupos correspondientes deben liberarse en la misma operación. Un componente agregado por la modificación debe fijar su tarifa base vigente al momento de agregarlo y recibir solo los descuentos del contexto original que le sean aplicables; los componentes originales deben conservar su tarifa y sus reglas de descuento, aunque un descuento haya vencido, y los pagos posteriores no deben volver a consultar el catálogo.
...
- CA-010: Debe ser posible gestionar una única caja por día calendario del tenant con base de efectivo físico parametrizable por el Administrador del tenant, ingresos, pagos, gastos, devoluciones, cierre, reapertura con motivo e histórico, y obtener la consolidación mensual. La apertura, el cierre y la reapertura solo deben poder realizarlos el Administrador del tenant o un Colaborador operativo con el permiso Gestionar caja, con registro de usuario, fecha, hora y motivo de reapertura. En el cierre, las entradas y salidas deben mostrarse por medio de pago, el efectivo esperado debe calcularse como la base más las entradas en efectivo menos las salidas en efectivo, y las transferencias deben conciliarse por separado. Una transferencia validada o una devolución ejecutada por transferencia después del cierre en el mismo día debe registrarse como movimiento no efectivo posterior al cierre sin reabrir la caja; si se valida otro día, debe pertenecer a la caja de ese día, que se crea automáticamente si no existe, sin base y sin modificar el efectivo esperado, igual que para cualquier otro movimiento no efectivo, como una devolución por transferencia; nunca debe existir más de una caja por tenant y fecha. Una caja creada automáticamente debe quedar Abierta con origen automático; si al finalizar el día no tuvo apertura operativa ni movimientos en efectivo, debe cerrarse automáticamente con auditoría y conservar sus movimientos; si tuvo apertura operativa, debe exigir cierre formal. Una caja con apertura operativa no cerrada al finalizar su día debe dejar de aceptar movimientos, quedar marcada como Pendiente de cierre, generar una alerta en el panel de los Administradores del tenant activos y de los usuarios con el permiso Gestionar caja, y no impedir la operación de la caja del día siguiente. No debe poder activarse un cambio de zona horaria con una caja Abierta o Pendiente de cierre, y después del cambio los movimientos deben asignarse a la caja de su fecha local según la nueva zona sin crear una segunda caja para esa fecha.
...
- CA-015B: Debe ser posible calcular, autorizar, registrar y ejecutar devoluciones monetarias con causal, responsable, monto, relación con la reserva y relación con el movimiento de caja correspondiente. Cuando una reserva se cancele por incumplimiento del pago con valores validados, el Administrador del tenant debe poder registrar dentro de 24 horas corridas la decisión entre devolución del 100 % o saldo a favor por el total; el plazo debe contarse desde que el dinero queda reconocido; si no decide, el sistema debe registrar la devolución del 100 % como pendiente de ejecución y notificar a todos los Administradores del tenant activos por alerta en el panel y correo electrónico. Cuando la cancelación se deba a una causa no atribuible al cliente, la devolución debe ser del 100 % de los valores pagados y validados. Toda devolución determinada debe ejecutarse en un máximo de 5 días hábiles; si no, debe marcarse como vencida y generar una alerta en el panel de los Administradores del tenant activos. Un excedente por modificación que reduce el valor debe tratarse con la misma decisión de 24 horas y devolución por defecto. Toda devolución determinada automáticamente por vencer la decisión de 24 horas, incluidos el excedente por modificación y la cancelación solicitada por el cliente, debe notificarse con la misma alerta persistente en el panel y el mismo correo a todos los Administradores del tenant activos, con reserva, cliente, monto, motivo y estado pendiente de ejecución; el fallo del correo no debe modificar la decisión y debe quedar registrado. El saldo a favor debe poder aplicarse a una nueva reserva del mismo tenant como pago validado y devolverse a solicitud del cliente con autorización del Administrador del tenant, que dispone de 24 horas corridas para autorizarla o rechazarla de forma justificada; si no registra una decisión, la devolución por el monto solicitado que continúe disponible debe autorizarse automáticamente, notificarse como las demás devoluciones determinadas automáticamente y ejecutarse en un máximo de 5 días hábiles. El saldo a favor debe poder aplicarlo el cliente desde su flujo de pago o un Colaborador operativo o el Administrador del tenant por cuenta del cliente, con auditoría del monto consumido.
- CA-015C: Debe ser posible reagendar una reserva o servicio afectado, conservando trazabilidad con la reserva original, disponibilidad recalculada y saldo resultante. Un cambio exclusivo de fecha debe registrarse sobre la misma reserva con su historial, solo si hay disponibilidad en la nueva salida y no existe un comprobante En validación, trasladando el cupo en una única operación; solo un cambio de servicio principal o de condición comercial debe generar una nueva reserva vinculada. La reprogramación por emergencia no debe quedar bloqueada por la política de cambios del cliente y debe registrar la aceptación del cliente cuando implique una nueva fecha. Si la reprogramación se debe a una causa no atribuible al cliente y el cliente no la acepta, la reserva debe cancelarse con devolución del 100 %. Si el Administrador del tenant no propone una nueva salida dentro de las 24 horas corridas siguientes a la cancelación o interrupción, la reserva debe cancelarse con devolución del 100 %; la falta de una alternativa inmediata no debe obligar a cancelar antes de ese plazo, salvo que el Administrador del tenant declare que no habrá alternativa, y ese plazo no debe congelarse con el tenant inactivo. Desde la cancelación o interrupción de la salida y durante el plazo de respuesta del cliente, los plazos económicos deben permanecer congelados, y la hora programada de la salida cancelada no debe cancelar reservas por incumplimiento de pago. La propuesta solo debe poder enviarse si la nueva salida tiene capacidad suficiente, y los cupos de los viajeros deben quedar apartados en ella hasta que el cliente acepte (se asocian a la reserva), rechace, venza el plazo o llegue la hora programada de la nueva salida (se liberan). El cliente debe disponer de hasta 72 horas corridas desde la notificación para responder, sin superar la hora programada de la nueva salida ni el tiempo restante del episodio de reprogramación; si no responde dentro de ese plazo, la reserva debe cancelarse con devolución del 100 %. Si la salida propuesta se cancela por cualquier causa válida, la propuesta debe quedar sin efecto sin contarse como rechazo ni como falta de respuesta, sus cupos deben liberarse de inmediato y la reserva no debe quedar vinculada a esa salida: con el tenant activo debe comenzar un nuevo plazo L1 igual al menor entre 24 horas y el tiempo restante del episodio, en el que una nueva propuesta inicia un nuevo plazo de respuesta igual al menor entre 72 horas, el tiempo restante del episodio de reprogramación y la hora programada de la salida propuesta, sin reiniciar el límite del episodio ni garantizar 72 horas completas, y, sin nueva propuesta, la reserva debe cancelarse por causa no atribuible al cliente con devolución del 100 %; si la cancelación se produce conforme a I1 con el tenant inactivo, la reserva debe cancelarse de inmediato con devolución del 100 %, sin nuevo plazo L1 ni nueva propuesta. El cliente debe poder responder desde su panel, y un Colaborador operativo o el Administrador del tenant debe poder registrar la respuesta recibida por un canal externo con evidencia, actor y fecha y hora. Cada cancelación o interrupción de la salida original debe iniciar un único episodio de reprogramación con un límite máximo computable de 96 horas, cuyo cómputo solo debe pausarse mientras una propuesta pendiente tenga su plazo de respuesta congelado por la inactividad del tenant: las propuestas sustitutas no deben reiniciarlo ni enviarse después de su vencimiento, el plazo de respuesta de cada propuesta debe ser el menor entre 72 horas, el tiempo restante del episodio y la hora programada de la salida propuesta, y al alcanzarse el límite sin alternativa aceptada la reserva debe cancelarse por causa no atribuible al cliente con devolución del 100 % y liberación de todos los cupos relacionados. Una aceptación efectiva debe cerrar el episodio, y una cancelación posterior de la nueva salida debe iniciar un nuevo episodio independiente.
...
- CA-017: Debe ser posible que el Administrador de plataforma cree un tenant con sus datos obligatorios, su zona horaria oficial, su país y su primer Administrador, y que lo inactive o reactive con motivo registrado. Al inactivarlo, deben revocarse de inmediato los accesos de operación normal de todos los usuarios del tenant, sin bloquear al Administrador de plataforma ni otorgarle acceso a los datos del tenant; el Administrador del tenant debe conservar solo un acceso restringido para gestionar obligaciones pendientes y registrar las devoluciones y movimientos financieros necesarios, con auditoría; no deben aceptarse nuevas reservas, pagos ni ventas, y deben suspenderse los plazos operativos y sus cancelaciones automáticas, pero no los temporizadores de seguridad ni los plazos de contingencia: las 24 horas corridas para proponer una reprogramación y los 5 días hábiles para ejecutar una devolución. Al reactivarlo, cada plazo debe continuar con el tiempo restante y los usuarios inactivados individualmente deben seguir inactivos. Con el acceso restringido, el Administrador del tenant solo debe poder registrar, para las salidas que ya estaban En ejecución, sus novedades de ejecución, servicios prestados y no prestados, interrupción y cierre, y validar o rechazar los comprobantes presentados antes de la inactivación, sin aceptar comprobantes ni pagos nuevos. Si la hora programada de una salida se alcanza con el tenant inactivo, la salida debe cancelarse automáticamente sin cancelar reservas por incumplimiento de pago, y no debe reactivarse al reactivar el tenant. El plazo de 72 horas de respuesta a una propuesta de reprogramación debe congelarse siempre durante la inactivación y reanudarse solo con el tiempo restante; una respuesta enviada por el cliente por un canal externo y registrada por el Administrador del tenant debe producir efecto inmediato. Si la salida propuesta en una reprogramación pendiente se cancela conforme a I1 durante la inactivación, la propuesta debe quedar sin efecto, sus cupos deben liberarse y la reserva debe cancelarse por causa no atribuible al cliente con devolución del 100 %, sin abrir un nuevo plazo L1 ni permitir otra propuesta durante esa inactivación; la reactivación no debe revivir la reserva. Con el tenant inactivo, si no existe una propuesta pendiente, el plazo L1 y el cómputo del episodio de reprogramación deben seguir corriendo y, si L1 vence sin propuesta, la reserva debe cancelarse con devolución del 100 %; si existe una propuesta pendiente, deben congelarse durante el mismo periodo el plazo de respuesta y el tiempo restante del episodio, y ambos deben reanudarse con su tiempo restante al reactivarse el tenant.
- CA-018: Debe ser posible que un Administrador del tenant registre usuarios internos (Administradores del tenant adicionales, Gerentes, Contadores, Analistas y Colaboradores operativos) con nombre completo, correo electrónico, contraseña inicial y confirmación coincidentes que cumplan la política centralizada de contraseñas. La credencial temporal debe vencer a las 72 horas y, al usarla por primera vez, el usuario debe establecer su propia contraseña antes de acceder normalmente. Si vence, la cuenta debe seguir registrada y el administrador correspondiente debe poder emitir una nueva credencial que invalide la anterior, con trazabilidad; si ningún Administrador del tenant activo puede autenticarse, el Administrador de plataforma debe poder emitirla a cualquier Administrador del tenant activo, con auditoría. El registro debe bloquearse si el correo ya existe en el mismo tenant, activo o inactivo, indicando la reactivación cuando el usuario existente esté inactivo. Debe ser posible inactivar y reactivar usuarios con trazabilidad, un usuario inactivo no debe poder autenticarse y el sistema no debe permitir inactivar al último Administrador del tenant activo.
...
- CA-021: La información médica, el tipo de sangre, las restricciones físicas y los contactos de emergencia de una reserva deben eliminarse de los sistemas activos al cumplirse un año desde la finalización del servicio (o desde la hora de fin estimada, si la salida lleva más de 7 días calendario sin regularizarse) o desde el cierre definitivo de una reserva cancelada —o desde la cancelación, si ese cierre queda bloqueado por la inactivación del tenant—, conservando los consentimientos y el histórico comercial. Solo los usuarios con el permiso Consultar datos sensibles deben poder consultarlos, con auditoría; Gerente, Contador y Analista no deben poder hacerlo. El Administrador de plataforma no debe poder consultar datos de un tenant sin una autorización del Administrador del tenant de máximo 24 horas o un acceso de emergencia justificado y auditado, que solo debe alcanzar datos sensibles si su alcance los incluye expresamente con justificación específica. Al usarse un acceso de emergencia, todos los Administradores del tenant activos deben recibir un correo al iniciarse el acceso y otro al finalizar, con el tenant, el Administrador de plataforma, el motivo, la fecha y hora de inicio, el alcance y, en el de finalización, la fecha y hora de finalización, sin datos sensibles; un fallo del correo debe quedar registrado sin invalidar el acceso.
...
- CA-023: Debe ser posible que el Administrador del tenant programe salidas con fecha, hora de inicio y hora de finalización estimada, les asigne vehículos y cancele salidas Programadas. La capacidad efectiva de una salida con transporte obligatorio debe ser el menor valor entre la capacidad del tour y la suma de las capacidades de los vehículos asignados; el sistema no debe permitir asignar un mismo vehículo a salidas con intervalos programados superpuestos ni reducir la capacidad del tour o del transporte por debajo de los cupos ya apartados o asignados. Al alcanzarse la hora programada de inicio, el sistema debe bloquear pagos y comprobantes de la salida y cancelar las reservas con pagos pendientes o comprobantes En validación, sin depender del registro del inicio real. El Administrador del tenant o un Colaborador operativo con el permiso Gestionar ejecución de salidas deben poder registrar el inicio real y la finalización: al registrar el inicio, solo las reservas Confirmadas con Pago completo deben pasar a En ejecución; al registrar la finalización, las reservas En ejecución deben pasar a Finalizada, salvo cuando se registra una interrupción. El inicio real no debe poder registrarse antes de la hora programada de inicio. Una salida Programada sin reservas debe poder cambiar su fecha u hora directamente, respetando transporte y solapamiento; una salida Programada con reservas no debe poder cambiarla: la salida original debe quedar Cancelada por causa no atribuible al cliente, sin modificarse, y la nueva salida debe proponerse a cada reserva, que debe pasar a ella si acepta o cancelarse con devolución del 100 % si rechaza o no responde, contando el plazo L1 desde la cancelación de la original. Ante una interrupción no atribuible al cliente, una reserva En ejecución debe poder volver a Confirmada con una nueva salida si el cliente acepta, o cancelarse con devolución del 100 % si no acepta.
- CA-024: Toda cuenta de Cliente final debe quedar activada solo después de verificar su correo electrónico. Al registrar manualmente un cliente, el sistema debe normalizar el correo y buscar coincidencias en el mismo tenant entre cuentas verificadas, cuentas no verificadas y registros manuales: con una cuenta verificada debe vincularse en lugar de crear un duplicado; con una coincidencia no verificada no debe crear el duplicado ni fusionar identidades automáticamente, y solo el Administrador del tenant debe poder resolverla: vinculando tras verificar la propiedad del correo si es la misma persona, o corrigiendo la información si son personas distintas o el correo es incorrecto. Cuando un cliente registrado manualmente cree una cuenta con el mismo correo, el sistema debe vincularla al verificarse el correo, conservando reservas, pagos, saldos e histórico, sin crear un segundo registro de cliente.
...
- CA-027: Todo plazo en días hábiles debe excluir sábados, domingos y festivos nacionales del país del tenant. Toda fecha y hora de la operación de un tenant (salidas, cajas, validaciones, vencimientos, reportes e históricos) debe registrarse e interpretarse en la zona horaria oficial del tenant, y un cambio de zona horaria debe aplicarse solo a operaciones futuras: las salidas y registros ya creados deben conservar su zona horaria e instante, los plazos iniciados no deben reinterpretarse y las cajas existentes deben conservar la zona horaria con la que fueron creadas. El cambio de zona horaria no debe poder activarse con una caja Abierta o Pendiente de cierre; después del cambio, cada movimiento debe asignarse a la caja de su fecha local según la nueva zona, reutilizando la caja existente de esa fecha, y la activación debe auditarse con zona anterior, zona nueva, fecha y hora efectiva y usuario. Un cambio de país debe quedar auditado, no recalcular plazos ya iniciados y aplicarse solo a los plazos creados después del cambio.
- CA-028: Cuando durante una salida iniciada un cliente o una persona de su reserva no pueda continuar por una emergencia personal, debe poder registrarse como novedad de ejecución sin cancelar la reserva; al registrarla, el sistema debe calcular inmediatamente el monto reembolsable según la política vigente del servicio: si es $0, no debe generarse devolución y la reserva debe finalizar con la novedad en su historial; si es mayor que $0, la devolución debe quedar determinada y autorizada automáticamente, pendiente de ejecución dentro de 5 días hábiles, sin decisión adicional del Administrador del tenant.
- CA-029: Una salida debe iniciar en estado Programada y solo debe poder pasar a En ejecución al registrarse su inicio real, a Finalizada al registrarse su finalización y a Cancelada antes de su inicio, por decisión del Administrador del tenant, por regularización como no realizada de una salida cuya hora programada ya pasó, registrada por el Administrador del tenant o un usuario con el permiso Gestionar ejecución de salidas, o automáticamente cuando su hora programada se alcanza con el tenant inactivo; una salida Cancelada no debe reactivarse. Al alcanzarse la hora programada de inicio sin registro, debe generarse una alerta en el panel de los Administradores del tenant activos y de los usuarios con el permiso Gestionar ejecución de salidas; al superarse la hora de finalización estimada sin cierre, la salida debe quedar marcada como pendiente de regularización sin cerrarse automáticamente, y debe poder regularizarse como ejecutada y finalizada, cancelada o interrumpida con la hora real, el responsable y la fecha del registro. En operación normal no debe poder registrarse un inicio real anterior a la hora programada; en una regularización debe poder registrarse con motivo obligatorio y auditoría, conservando la hora programada y la real, sin alterar vencimientos, bloqueo de pagos ni cancelaciones económicas. Al cancelarse una salida, por decisión del Administrador del tenant, por regularización o conforme a I1, toda propuesta de reprogramación pendiente hacia ella debe quedar sin efecto y liberar sus cupos.
- CA-030: El Administrador del tenant debe disponer por su perfil de los permisos Validar comprobantes, Gestionar caja y Gestionar ejecución de salidas, y solo debe poder consultar datos sensibles si tiene asignado explícitamente el permiso Consultar datos sensibles, aunque se lo haya asignado a sí mismo; la asignación y cada consulta deben quedar auditadas. Un Colaborador operativo con el permiso Gestionar ejecución de salidas debe poder registrar inicio, finalización, interrupciones y novedades, y regularizar salidas pasadas, incluida su cancelación por no realizarse, pero no debe poder cancelar una salida futura Programada.
- CA-031: Debe ser posible que un Colaborador operativo o el Administrador del tenant registren la cancelación de una reserva solicitada por el cliente; la reserva debe pasar a Cancelada sin posibilidad de reactivación, liberar su cupo y, si existen valores pagados, debe descontarse la penalidad de la política de cancelación vigente para obtener el monto reembolsable; sobre ese monto, el Administrador del tenant debe poder decidir en 24 horas corridas entre devolución del 100 % o saldo a favor del 100 %, con devolución del 100 % por defecto si no decide, notificada a todos los Administradores del tenant activos por alerta en el panel y correo electrónico.
- CA-032: Debe ser posible reconocer un comprobante presentado antes de una cancelación y aprobado después, sin reactivar la reserva: si la cancelación fue por causa atribuible al tenant o no atribuible al cliente, debe devolverse el 100 % del valor reconocido; si fue solicitada por el cliente, la penalidad, porcentual o fija, debe calcularse una sola vez sobre el total validado, sin duplicar una penalidad fija, y el incremento del monto reembolsable debe seguir el mismo tratamiento ya decidido o determinado (devolución o saldo a favor) sin iniciar una segunda decisión de 24 horas, o incorporarse a la decisión si sigue en curso; si fue por incumplimiento del pago, debe aplicarse el tratamiento pendiente. Por ejemplo, con $100.000 validados, penalidad fija de $20.000 y un comprobante tardío de $50.000, el reembolsable final debe ser $130.000.
- CA-033: Con el tenant inactivo y una salida todavía Programada cuya hora programada no ha llegado, el Administrador del tenant debe poder registrar con su acceso restringido la solicitud voluntaria de cancelación del cliente, aplicando la política normal de cancelación del cliente y su tratamiento financiero, con la decisión de 24 horas congelada hasta la reactivación. Si la salida se cancela o llega su hora programada durante la inactivación sin que exista esa solicitud, la reserva debe gestionarse como causa no atribuible al cliente, con reprogramación o devolución del 100 %.
- CA-034: Con el tenant inactivo, si un comprobante que ya estaba En validación y cuyo plazo venció antes de la inactivación se rechaza, o se aprueba por un monto insuficiente para el requisito vencido, antes de la hora programada de la salida, la reserva debe cancelarse de inmediato con liberación del cupo y tratamiento pendiente de los valores validados. Si la hora programada ya ocurrió durante la inactivación y la salida fue cancelada por causa no atribuible al cliente, la reserva no debe cancelarse por incumplimiento económico y debe gestionarse con reprogramación o devolución del 100 %.

## 23. Trazabilidad

| ID | Objetivo / Proceso | RF / RN relacionado | Criterio de aceptación | Estado |
| --- | --- | --- | --- | --- |
| TRA-001 | Centralizar información base para reservas | RF-001, RN-CLI-001, RN-CLI-003 | CA-001 | CONFIRMADO |
| TRA-002 | Gestionar acompañantes dentro de la reserva | RF-002, RN-CLI-002, RN-CLI-003, RN-RES-005 | CA-002 | CONFIRMADO |
...
| TRA-014A | Registrar y validar pagos de reserva | RF-015A, RN-RES-004, RN-RES-006, RN-RES-006A, RN-RES-006B, RN-RES-006C, RN-RES-006D, RN-RES-009, RN-CAJ-001 | CA-015A, CA-025, CA-026, CA-034 | CONFIRMADO |
| TRA-014B | Gestionar devoluciones de reserva | RF-015B, RN-RES-008, RN-RES-009, RN-CAJ-001 | CA-015B, CA-032 | CONFIRMADO |
...
| TRA-016 | Gestionar tenants de la plataforma | RF-016, Regla operativa mínima de tenant (sección 9) | CA-017, CA-027, CA-033, CA-034 | CONFIRMADO |
...
| TRA-024 | Cancelar reserva a solicitud del cliente | RF-021, RN-RES-006C, RN-RES-008 | CA-031, CA-032, CA-033 | CONFIRMADO |
...
| C3 (ajustada por E5 y E14) | Comprobante En validación al vencer el plazo | No se cancela y conserva cupo; revisión máxima de 24 horas con alerta en el panel de todos los usuarios con el permiso Validar comprobantes; sin comprobante dentro del plazo se cancela y libera cupo | RN-RES-006, RN-RES-006C, sección 15, sección 16, CA-015 |
...
| D6 (ajustada por E14) | Comprobante sin decisión por más de 24 horas | Revisión vencida con alerta en el panel de todos los usuarios con el permiso Validar comprobantes | RN-RES-006C, CA-015 |
...
| E17 (ajustada por GAP-014 y GAP-015) | Saldo a favor | Sin vencimiento; aplicable como pago validado; devolvible con autorización; no transferible entre tenants | RN-RES-009, CA-015B |
...
| G4 (ajustada por GAP-001) | Plazos y caja con tenant inactivo | Se suspenden los plazos operativos, no los de seguridad ni los de contingencia (24 horas para proponer reprogramación y 5 días hábiles para ejecutar devoluciones); el Administrador del tenant registra devoluciones y movimientos necesarios | Sección 9, RF-016, RN-CAJ-001, CA-017 |
...
| G11 (ajustada por L3 y GAP-002) | Cierre definitivo | Registro del saldo a favor; en devolución, lo que ocurra primero entre su ejecución y el vencimiento de los 5 días hábiles; sin valores por tratar, la cancelación; si la inactivación del tenant bloquea el cierre, la retención cuenta desde la cancelación | Sección 17, glosario |
...
| H5 (ajustada por AC-02) | Notificación del tratamiento predeterminado | A todos los Administradores del tenant activos, por panel y correo | RN-RES-006C, CA-015B |
| H6 | Correo por cancelación o reprogramación de salida | Se agrega a los correos transaccionales al cliente | RF-019, CA-022 |
| H7 (ajustada por AB-01) | Emergencia personal del cliente | Novedad de ejecución que no cancela la reserva ni genera devolución por sí misma; el monto reembolsable se calcula según la política vigente | RN-EJE-002, glosario |
...
| I1 (ajustada por FINAL-010) | Salida alcanzada con tenant inactivo | La salida se cancela automáticamente por causa no atribuible al cliente, sin cancelaciones por incumplimiento de pago; no se reactiva al reactivar el tenant; si era la salida propuesta de una reprogramación pendiente, la reserva se cancela con devolución del 100 %, sin nuevo plazo L1 | Sección 9, RN-EJE-001, RN-EJE-002, sección 16, CA-017, CA-029 |
| I2 (ajustada por FINAL-002, FINAL-010 y FINAL-011) | Respuesta a la reprogramación | 72 horas corridas desde la notificación, sin superar la nueva salida; sin respuesta, cancelación con devolución del 100 % | RN-EJE-002, RF-015C, sección 15, sección 16, CA-015C, glosario |
| J3 (ajustada por L4) | Salida sin cierre operativo | Alerta al alcanzar la hora programada de inicio sin registro y marca de pendiente de regularización al superar la hora de finalización estimada; sin cierre automático | RN-EJE-001, sección 16, CA-029 |
...
| K2 (ajustada por GAP-021) | Cancelación de una salida programada | La realiza el Administrador del tenant; la regularización de una salida ya pasada como no realizada también puede registrarla un usuario con el permiso Gestionar ejecución de salidas | Sección 16, RF-020 |
| K3 (ajustada por FINAL-010 y FINAL-011) | Cupo durante la propuesta de reprogramación | La propuesta solo se envía con capacidad suficiente; los cupos quedan apartados hasta la aceptación, el rechazo, el vencimiento la hora programada de la nueva salida o la cancelación de esa salida | RN-EJE-002, RN-RES-007, sección 16, CA-015C, glosario |
...
| L1 (ajustada por GAP-001, GAP-019, FINAL-010 y FINAL-011) | Reprogramación no propuesta | El Administrador del tenant tiene 24 horas corridas para proponer una salida con disponibilidad; si no, cancelación con devolución del 100 % | RN-EJE-002, sección 16, CA-015C |
| L2 (ajustada por Q3) | Plazos durante la respuesta a la reprogramación | Se congelan durante las 72 horas y continúan con el tiempo restante si el cliente acepta | RN-EJE-002, RN-RES-006, CA-015C |
| L3 (ajustada por Q1 y Q2) | Ejecución de devoluciones | Máximo 5 días hábiles; si no, marca de vencida y alerta; la retención empieza con lo que ocurra primero | RN-RES-008, sección 17, glosario, CA-015B |
...
| L5 (ajustada por GAP-005 y GAP-007) | Salida en ejecución con tenant inactivo | El acceso restringido del Administrador del tenant permite cerrar o interrumpir salidas en curso | Sección 9, CA-017 |
...
| L8 (ajustada por Q4) | Cancelación solicitada por el cliente | La registran el Colaborador o el Administrador del tenant; tratamiento en 24 horas con devolución por defecto | RF-021, sección 16, CA-031 |
| L9 (ajustada por Q5) | Verificación de correo del cliente | Obligatoria para activar la cuenta; el registro manual busca y vincula el cliente existente | Sección 9, proceso 12.1.1, CA-024 |
| L10 (ajustada por Q6 y AB-02) | Caja en un día sin apertura | Creación automática para movimientos electrónicos, sin base; una sola caja por tenant y fecha | RN-CAJ-001, sección 16, CA-010 |
| Q1 | Retención con salida sin regularizar | Tras 7 días calendario sin regularizar, el año de retención cuenta desde la hora de fin estimada; la salida no se cierra | Sección 16, sección 17, CA-021 |
| Q2 | Días hábiles | Lunes a viernes sin festivos nacionales del país del tenant, en su zona horaria; Travesía Natural: Colombia | Sección 9, glosario, CA-027 |
| Q3 | Congelación por salida cancelada o interrumpida | Los plazos económicos se congelan desde la cancelación o interrupción; la hora de una salida cancelada no cancela por incumplimiento | RN-EJE-001, RN-EJE-002, RN-RES-006, sección 16, CA-015C |
| Q4 | Penalidad en cancelación del cliente | Se aplica la penalidad vigente y la decisión de 24 horas recae sobre el monto reembolsable | RF-021, CA-031 |
| Q5 (ajustada por R1) | Coincidencias de correo | Búsqueda de coincidencias verificadas y no verificadas; advertencia sin fusión automática | Sección 9, CA-024 |
| Q6 (ajustada por AB-02) | Caja para movimientos no efectivos | Creación automática para entradas y salidas no efectivas | RN-CAJ-001, sección 16, CA-010 |
| R1 | Resolución de coincidencias de correo no verificado | Sin duplicado ni fusión automática; la resuelve el Administrador del tenant verificando y vinculando, o corrigiendo la información | Sección 9, CA-024 |
| R2 | Cambio de país del tenant | Lo define el Administrador de plataforma al crear el tenant y lo modifica el Administrador del tenant; auditado y solo prospectivo | Sección 9, sección 15, CA-027 |
| AB-01 | Emergencia personal del cliente durante la ejecución | La novedad no cancela la reserva; Multitour calcula de inmediato el monto reembolsable según la política vigente: $0 sin devolución y la reserva finaliza; mayor que $0 devolución determinada y autorizada automáticamente, pendiente de ejecución en 5 días hábiles | RN-EJE-002, CA-028, glosario |
| AB-02 | Estado de la caja creada automáticamente | Nace Abierta con origen automático; sin apertura operativa ni efectivo se cierra automáticamente al final del día con auditoría; con apertura operativa exige cierre formal | RN-CAJ-001, sección 16, CA-010 |
| AC-01 (ajustada por GAP-014) | Decisiones financieras de 24 horas con tenant inactivo | Se congelan las tres decisiones (valores abonados, excedente por modificación y cancelación del cliente) y continúan con el tiempo restante | Sección 9 |
| AC-02 (ajustada por GAP-014) | Notificación de devoluciones determinadas automáticamente | Misma alerta persistente en panel y correo a todos los Administradores del tenant activos en los tres casos; el fallo del correo no cambia la decisión y queda registrado | RN-RES-008, RN-RES-006C, RN-RES-004, RF-021, CA-015B, CA-031 |
| GAP-001 | Plazos de contingencia con tenant inactivo | No se congelan las 24 horas para proponer reprogramación ni los 5 días hábiles para ejecutar devoluciones; los demás plazos operativos sí | Sección 9, RF-016, RN-EJE-002, RN-RES-008, sección 16, CA-015C, CA-017 |
| GAP-002 | Retención con cierre bloqueado por inactivación | El año de retención cuenta desde la cancelación como límite subsidiario | Sección 17, CA-021, glosario |
| GAP-003 (ajustada por FINAL-005) | Comprobante aprobado después de la cancelación | Hereda la causa y el tratamiento de esa cancelación: no atribuible 100 %; cliente, penalidad calculada una sola vez sobre el total validado y mismo tratamiento sin segunda decisión; incumplimiento, 24 horas | RN-RES-006C, RF-021 |
| GAP-004 (ajustada por FINAL-001) | Aprobación insuficiente después del vencimiento | Sin nuevo plazo; cancelación inmediata y tratamiento pendiente de lo validado | RN-RES-006C, sección 16, CA-015 |
| GAP-005 (ajustada por FINAL-001) | Comprobantes con tenant inactivo | Solo se validan los presentados antes de la inactivación; sin comprobantes ni pagos nuevos | Sección 9, CA-017 |
| GAP-006 | Solicitud del cliente con tenant inactivo | Antes de la cancelación u hora de la salida, política normal del cliente; después, causa no atribuible | Sección 9 |
| GAP-007 | Salida en ejecución con tenant inactivo | El acceso restringido permite novedades, servicios prestados y no prestados, interrupción y cierre | Sección 9, CA-017 |
| GAP-008 (ajustada por FINAL-002) | Respuesta a la reprogramación | El cliente responde desde su panel o un usuario interno la registra con evidencia, actor y fecha y hora | Proceso 12.1.1, RF-014, RF-015C, RN-EJE-002, CA-015C |
| GAP-009 | Reducción de viajeros | Los cupos se liberan de inmediato, en la misma operación | RN-RES-007, RF-003A, CA-005C |
| GAP-010 (ajustada por FINAL-006) | Inicio anticipado | El inicio real no puede ser anterior a la hora programada, salvo en la regularización histórica como evidencia sin efecto económico | RN-EJE-001, sección 16, CA-023 |
| GAP-011 (ajustada por FINAL-003) | Cambio de horario de una salida | Sin reservas, cambio directo; con reservas, se cancela la salida original y se propone una nueva salida; cada reserva decide | RF-020, CA-023 |
| GAP-012 | Caja operativa no cerrada | Marca Pendiente de cierre, sin movimientos nuevos ni cierre automático, con alerta; el día siguiente opera independiente | RN-CAJ-001, sección 16, CA-010, glosario |
| GAP-013 | Devolución por transferencia después del cierre | Movimiento no efectivo posterior al cierre, sin reabrir | RN-CAJ-001, RF-010, CA-010 |
| GAP-014 | Devolución del saldo a favor | Solicitud del cliente o registrada por un usuario interno; 24 horas para autorizar o rechazar de forma justificada, congeladas con el tenant inactivo; sin decisión, autorización automática del monto disponible con la notificación de AC-02; 5 días hábiles para ejecutar | RN-RES-009, RN-RES-008, sección 9, sección 15, CA-015B |
| GAP-015 | Aplicación del saldo a favor | La aplica el cliente en su flujo de pago o un Colaborador o Administrador del tenant por su cuenta, con auditoría | RN-RES-009, RF-015A, RF-014, proceso 12.1.1, CA-015B |
| GAP-016 | Tenant sin administrador utilizable | El Administrador de plataforma puede reemitir credencial temporal a cualquier Administrador del tenant activo | Sección 9, CA-018 |
| GAP-017 (ajustada por FINAL-007) | Cambio de zona horaria | Registros y salidas conservan su zona e instante; plazos no se reinterpretan; no se activa con una caja Abierta o Pendiente de cierre; los movimientos posteriores se asignan por fecha local nueva a una sola caja | Sección 9, CA-027 |
| GAP-018 (ajustada por FINAL-004) | Fijación del precio y descuentos | Los descuentos generales quedan fijados en el contexto comercial de la reserva al crearla; los creados después no se aplican y los que vencen después no desaparecen; las modificaciones recalculan con las reglas fijadas; un descuento adicional expresamente autorizado puede incorporarse y recalcular | RN-RES-002, RN-RES-003, RN-RES-004, RF-003A, RF-005B, sección 11, CA-005B, CA-005C |
| GAP-019 | Sin alternativa inmediata al cancelar la salida | Se conservan las 24 horas completas; cancelación anticipada solo si se declara que no habrá alternativa | RN-EJE-002, CA-015C |
| GAP-020 | Acceso de emergencia y datos sensibles | Solo con alcance que los incluya expresamente y justificación específica | Sección 9, sección 17, CA-021 |
| GAP-021 | Regularización de una salida como no realizada | Puede registrarla un usuario con el permiso Gestionar ejecución de salidas; la cancelación de salidas futuras sigue reservada al Administrador del tenant | Sección 16, CA-029 |
| FINAL-001 | Comprobante resuelto durante la inactivación con plazo ya vencido | Rechazo o aprobación insuficiente cancelan de inmediato si la hora de la salida no ha llegado; si la salida ya fue cancelada por I1, prevalece la causa no atribuible | RN-RES-006C, sección 9, sección 16, CA-034 |
| FINAL-002 (ajustada por FINAL-011) | Respuesta a la reprogramación con tenant inactivo | Las 72 horas se congelan siempre; una respuesta externa registrada por el Administrador del tenant produce efecto inmediato; el tiempo restante del episodio se congela durante el mismo periodo; se reanudan ambos con su tiempo restante | RN-EJE-002, sección 9, CA-017 |
| FINAL-003 | Cambio de fecha u hora de una salida con reservas | Se cancela la salida original, se programa y propone una nueva; L1 desde la cancelación; cada reserva decide | RF-020, sección 16, CA-023 |
| FINAL-004 | Alcance del contexto comercial fijado | Componentes originales conservan tarifa y reglas de descuento; un componente agregado fija la tarifa vigente al agregarlo y usa los descuentos del contexto original aplicables | RN-RES-003, RN-RES-004, RN-TRA-002, RF-003A, CA-005C |
| FINAL-005 | Penalidad con comprobante aprobado tarde | Penalidad calculada una sola vez sobre el total validado; el incremento sigue el mismo tratamiento sin segunda decisión | RN-RES-006C, CA-032 |
| FINAL-006 | Inicio real anterior en la regularización | Se permite registrarlo con motivo y auditoría como evidencia; la hora programada sigue gobernando los plazos | RN-EJE-001, sección 16, CA-029 |
| FINAL-007 | Cambio de zona horaria y caja | No se activa con caja Abierta o Pendiente de cierre; asignación por fecha local nueva a una sola caja; activación auditada | Sección 9, sección 15, RN-CAJ-001, CA-010, CA-027 |
| FINAL-008 | Alcance de Gestionar ejecución de salidas | Inicio, finalización, interrupciones, novedades, regularización y actuaciones de RN-EJE-002; no cancela salidas futuras Programadas | Sección 9, sección 15, glosario, CA-030 |
| FINAL-009 | Criterios de aceptación y trazabilidad | Nuevos CA-032 a CA-034 y ampliación de los CA afectados | Sección 22, sección 23 |
| FINAL-010 (ajustada por FINAL-011) | Propuesta de reprogramación cuya salida propuesta deja de ser viable | Toda cancelación válida de la salida propuesta deja la propuesta sin efecto, sin contar como rechazo ni falta de respuesta, y libera los cupos; con el tenant activo, nuevo plazo L1 igual al menor entre 24 horas y el tiempo restante del episodio y nueva propuesta con un plazo de respuesta igual al menor entre 72 horas, el tiempo restante del episodio de reprogramación y la hora programada de la salida propuesta, sujeta al límite máximo computable del episodio (FINAL-011); con el tenant inactivo y cancelación por I1, cancelación inmediata de la reserva con devolución del 100 %, sin nuevo L1 ni nuevas propuestas | RN-EJE-002, RF-020, sección 9, sección 16, CA-015C, CA-017, CA-029, glosario |
| FINAL-011 | Límite del episodio de reprogramación | Un único episodio por cancelación o interrupción de la salida original, con límite máximo computable de 96 horas, cuyo cómputo solo se pausa durante una respuesta congelada por inactividad; con el tenant inactivo y sin propuesta, L1 y el episodio siguen corriendo; con propuesta pendiente, respuesta y episodio se congelan juntos; nuevo L1 igual al menor entre 24 horas y el tiempo restante; las propuestas sustitutas no lo reinician; respuesta igual al menor entre 72 horas, el tiempo restante del episodio y la hora de la salida propuesta; al vencer sin alternativa aceptada, cancelación con devolución del 100 % y liberación de cupos; la aceptación efectiva cierra el episodio y una nueva cancelación abre otro | RN-EJE-002, RF-015C, RF-020, sección 15, sección 16, CA-015C, glosario |
...
- Novedad de ejecución: registro de un hecho ocurrido durante una salida iniciada, como la emergencia personal de un cliente; no cancela la reserva ni genera por sí mismo una devolución, pero en una emergencia personal Multitour calcula el monto reembolsable según la política vigente del servicio (AB-01).
- Pendiente de respuesta de reprogramación: marca de una reserva afectada por la cancelación o interrupción de su salida mientras el cliente decide sobre la nueva salida propuesta, con un plazo máximo de 72 horas corridas y con los cupos de sus viajeros apartados en la salida propuesta; no es un estado de la reserva. Si la salida propuesta se cancela, la propuesta queda sin efecto: con el tenant activo comienza un nuevo plazo L1 igual al menor entre 24 horas y el tiempo restante del episodio; si se cancela conforme a I1 con el tenant inactivo, la reserva se cancela (FINAL-010).
- Episodio de reprogramación: periodo que se inicia para una reserva cuando su salida original se cancela o se interrumpe por una causa no atribuible al cliente, con un límite máximo computable de 96 horas desde esa cancelación o interrupción, cuyo cómputo solo se pausa mientras una propuesta pendiente tenga su plazo de respuesta congelado por la inactividad del tenant y que las propuestas sustitutas no reinician; termina con la aceptación efectiva de una nueva salida o con la cancelación de la reserva (FINAL-011).
...
- Cierre definitivo: momento en que se resuelven las obligaciones económicas de una reserva cancelada, a efectos de la retención de datos sensibles: el registro formal del saldo a favor; en una devolución, lo que ocurra primero entre su ejecución completada y el vencimiento de su plazo máximo de 5 días hábiles; o, si no hay valores por tratar, la cancelación misma. Si el cierre queda bloqueado por la inactivación del tenant, la retención se cuenta desde la cancelación (GAP-002).
...
- Días hábiles: días de lunes a viernes, excluyendo los festivos nacionales del país configurado para el tenant; el inicio y el final de cada día se determinan con la zona horaria oficial del tenant. Aplica, entre otros, al plazo máximo de 5 días hábiles para ejecutar una devolución (Q2).
...
- Permisos especiales: Validar comprobantes, Consultar datos sensibles, Gestionar caja y Gestionar ejecución de salidas; son los únicos asignables en Fase 1 además de los perfiles base. El Administrador del tenant tiene por su perfil Validar comprobantes, Gestionar caja y Gestionar ejecución de salidas; Consultar datos sensibles siempre requiere asignación explícita. Gestionar ejecución de salidas cubre el registro del inicio, la finalización, las interrupciones, las novedades y la regularización de las salidas, y las actuaciones extraordinarias de RN-EJE-002, sin habilitar la cancelación de salidas futuras Programadas (FINAL-008).
