...
- Fecha: 2026-09-23
- Versión: 1.9
- Estado documental: actualización de línea base funcional; incorpora el cierre de los pendientes GAP-01 a GAP-11 (sección 24.2) y las decisiones del equipo (sección 24.3); cerrado tras la auditoría final de consistencia y trazabilidad (sección 24)
...
- Zona horaria oficial y país del tenant, modificables por el Administrador del tenant con efecto prospectivo (G14, R2).
...
- Caja creada automáticamente: cuando debe registrarse un movimiento no efectivo, de entrada o de salida, en un día sin caja, la caja de ese día se crea automáticamente solo para movimientos no efectivos, sin apertura física ni base; para movimientos en efectivo se abre esa misma caja (L10, Q6).
...
- CA-029: Una salida debe iniciar en estado Programada y solo debe poder pasar a En ejecución al registrarse su inicio real, a Finalizada al registrarse su finalización y a Cancelada antes de su inicio, por decisión del Administrador del tenant o automáticamente cuando su hora programada se alcanza con el tenant inactivo; una salida Cancelada no debe reactivarse. Al alcanzarse la hora programada de inicio sin registro, debe generarse una alerta en el panel de los Administradores del tenant activos y de los usuarios con el permiso Gestionar ejecución de salidas; al superarse la hora de finalización estimada sin cierre, la salida debe quedar marcada como pendiente de regularización sin cerrarse automáticamente, y debe poder regularizarse como ejecutada y finalizada, cancelada o interrumpida con la hora real, el responsable y la fecha del registro.
...
Tras la auditoría final de consistencia y trazabilidad del 2026-09-23, este PDR no presenta decisiones humanas pendientes ni contradicciones dentro del alcance de Fase 1. Las decisiones que cerraron los pendientes identificados durante la revisión están registradas en las secciones 24.2 y 24.3. Cualquier ajuste posterior debe tratarse como cambio controlado en una nueva versión del documento.

## 24.1 Definiciones de cierre para Fase 1

- Superada la auditoría final de consistencia y trazabilidad sin decisiones pendientes, esta versión 1.9 del 2026-09-23 se declara como línea base funcional final de Fase 1 para la entrega académica.
...
| L10 (ajustada por Q6) | Caja en un día sin apertura | Creación automática para movimientos electrónicos, sin base; una sola caja por tenant y fecha | RN-CAJ-001, sección 16, CA-010 |
...
| Q6 | Caja para movimientos no efectivos | Creación automática para entradas y salidas no efectivas | RN-CAJ-001, sección 16, CA-010 |
